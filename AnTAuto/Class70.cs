...
internal class Class70
{
	...
	public static void smethod_0(int int_0)
	{
		...
		while (true)
		{
			IL_3ED5:
			Thread.Sleep(200);
			int num25 = Class71.smethod_3(Form1.gstruct42_0, int_0);
			if (Class11.bool_0 || num25 < 0 || Form1.int_20 != 2)
			{
				break;
			}
			gStruct = Form1.gstruct42_0[num25];
			...
			if (!gStruct.bool_21 && !gStruct.bool_6)
			{
				if (gStruct.bool_27)
				{
					Form1.gstruct42_0[num25].bool_27 = false;
					flag = false;
					gStruct = Form1.gstruct42_0[num25];
				}
				if (Form1.int_24 != 1)
						...
						if (num33 != 0 && num32 != 0 && num34 != 0 && num37 > 1 && num32 != 10 && num32 != 21)
						{
							if (!gStruct.bool_29 && !flag9)
							{
								...
								if (array5[0] > 0u && array5[1] > 0u)
								{
									...
									else if (num == num34 && (num2 == Class38.gstruct29_0.int_4 || Form1.int_21 <= 0))
									{
										if (num4 != Form1.int_100)
										{
											flag5 = false;
											num7 = 0;
											num4 = Form1.int_100;
										...
										if (gStruct.int_129 != Class38.gstruct29_0.int_0)
										{
											if (num39 <= 180 && num40 < Form1.int_51)
											{
												num40 = Form1.int_51;
											}
											if (gStruct.int_123[0] > 0 && Form1.int_27 > 0 && num40 > 180)
											{
												num40 = 180;
											}
										}
										...
										bool flag12 = false;
										bool flag13 = false;
										if ((Form1.int_45 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_0 > 0 && 926 <= Class38.gstruct29_0.int_4 && Class38.gstruct29_0.int_4 <= 932 && num24 != Class38.gstruct29_0.int_4) || num4 != Form1.int_100)
										{
											flag5 = false;
											num7 = 0;
											num4 = Form1.int_100;
										...
										if (!Class89.smethod_0(num34))
										{
											if (num35 > 0)
											{
												...
												int int_ = Class89.struct31_0[Form1.int_100].int_0;
											...
											else if (!flag6)
											{
												...
												if (flag && num5 >= 0 && num5 == num42)
												{
													...
													int int_2 = Class89.struct31_0[Form1.int_100].int_0;
													uint[] array7 = Class89.struct31_0[Form1.int_100].uint_0;
													string text2 = Class89.struct31_0[Form1.int_100].string_0;
													string string_ = Class89.struct31_0[Form1.int_100].string_1;
													string string_2 = Class89.struct31_0[Form1.int_102].string_1;
													if (Form1.int_45 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_6 > 0 && 926 <= Class38.gstruct29_0.int_4 && Class38.gstruct29_0.int_4 <= 932)
													{
													...
													if (Form1.int_99 > 0 && gStruct.bool_63)
													{
														Class76.smethod_9(gStruct, false);
														if (Class53.smethod_17(gStruct, "ThÇn Hµnh", false))
														{
															...
															if (Form1.int_103 > 0)
															{
																Class76.smethod_6(gStruct, Form1.int_103 - 1);
															}
															while (true)
															{
																num51++;
													...
													IL_122C:
													if (Form1.int_101 <= 0 || num16 < Form1.int_39 || (Form1.int_40 <= 0 && num16 >= Form1.int_39 * 2))
													{
														if (num16 >= Form1.int_39 * 2)
														{
															num16 = 0;
														}
													}
													...
													{
														array7 = Class89.struct31_0[Form1.int_102].uint_0;
														text2 = Class89.struct31_0[Form1.int_102].string_0;
														string_ = Class89.struct31_0[Form1.int_102].string_1;
														int_2 = Class89.struct31_0[Form1.int_102].int_0;
														flag5 = true;
														if (text != null && text != string.Empty)
														{
															text2 = text;
														...
														if (array7 == null)
														{
															...
															while (m < array4.GetLength(0))
															{
																...
																else
																{
																	...
																	{
																		string string_4 = Class89.struct31_0[Form1.int_100].string_1;
												...
												else
												{
													if (!Form1.bool_3)
													{
														int num70 = Class30.smethod_1(gStruct, Form1.int_92 <= 0);
														if (num70 == 0)
														{
															Thread.Sleep(300);
															continue;
										...
										else
										{
											...
											bool flag15 = (Form1.int_6 > 0 || Form1.int_7 > 0) && Form1.int_21 > 0 && (Class38.gstruct29_1.int_3 > 0 || Form1.int_22 > 0) && Class38.gstruct29_1.int_4 > 0 && Class11.smethod_57(Class38.gstruct29_1.uint_4) && (gStruct.int_129 == Class38.gstruct29_0.int_0 || Class38.gstruct29_0.int_0 <= 0);
											if (Form1.int_21 <= 0 || (Form1.int_22 <= 0 && Class38.gstruct29_0.int_3 <= 0) || Class38.gstruct29_0.int_0 == gStruct.int_129 || !Class11.smethod_57(Class38.gstruct29_0.uint_4) || Class38.gstruct29_0.int_0 <= 0 || Class38.gstruct29_0.int_6 <= 0)
											{
											...
											else
											{
												...
												if (Class38.gstruct29_0.int_4 == num34 && Class89.smethod_0(num34))
												{
													...
													if (!flag8 && num64 <= (long)(num40 * num40))
													{
														...
														array = null;
														num9 = 0;
														if (num35 > 0 && !gStruct.bool_33 && gStruct.bool_64 && gStruct.int_90 == 1 && Form1.int_96 > 0 && (Form1.int_31 > 0 || Form1.int_30 > 0 || Form1.int_32 > 0) && Class20.smethod_30(num30 + Class47.gstruct43_44.uint_0, gStruct.int_130) > 0u && Class20.smethod_30(num30 + Class47.gstruct43_43.uint_0, gStruct.int_130) > 0u && Class11.smethod_23(long_2) > 600L)
														{
														...
														if (num15 <= 0L || Class11.smethod_23(num15) >= 1500L)
														{
															...
															{
																num15 = 0L;
																if (num19 == 0 && Class53.smethod_18(uint_3, Class38.gstruct29_0.uint_4) > (long)(Form1.int_23 * Form1.int_23))
																{
																	num11++;
																	if (num11 > 3)
																	{
																...
																if (Form1.int_27 > 0 && num35 > 0 && gStruct.int_123[0] > 0 && Class60.smethod_3(gStruct, Class60.uint_13) == 0)
																{
													...
													if (num64 > (long)(Form1.int_95 * Form1.int_95))
													{
											...
											bool flag16 = Form1.int_21 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_6 > 0 && Class38.gstruct29_0.int_4 == num34;
											flag13 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0));
											...
											if (Class60.smethod_3(gStruct, Class60.uint_6) <= 0)
											{
												if (!gStruct.bool_33)
												{
													...
													if (FormDame.int_6 > 0 && !flag12)
													{
														...
														uint[] array20 = Class53.smethod_3(uint_5, array18, -1 * (Form1.int_23 - 50));
													...
													if (flag13)
													{
														if (!Class38.smethod_6(gStruct, ref num22) && Class73.smethod_12(gStruct) != 1)
														{
															...
															uint num84 = 0u;
															if (Form1.int_33 > 0 && (flag15 || flag16))
															{
																if (!flag15)
																{
															...
															else if (!(flag13 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0))))
															{
																flag13 = false;
															}
															else
															{
																...
																if (array21 != null)
																{
																	...
																	while (array21[num102, 1] > 0)
																	{
																		...
																		if (Form1.int_50 > 0 && (num90 <= 0 || num90 == array2[0]) && array2[1] > 0 && array2[2] == num34 && array2[3] > 0)
																		{
																			int num104 = array2[0];
																			int num105 = array2[1];
							...
							else
							{
								...
								num25 = Class71.smethod_3(Form1.gstruct42_0, int_0);
								if (0 <= num25)
								{
									Form1.gstruct42_0[num25].bool_29 = flag25;
								}
								if (!flag25)
								{
									Class11.smethod_22();
