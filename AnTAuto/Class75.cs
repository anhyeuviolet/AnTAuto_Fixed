...
internal class Class75
{
	...
	public static void smethod_1(int int_0)
	{
		...
		{
			Thread.Sleep(200);
			num8 = Class71.smethod_3(Form1.gstruct42_0, int_0);
			...
			if (!flag2)
			{
				...
				case 175:
					if (num2 > 0 || num > 0)
					{
						...
						{
							num8 = Class71.smethod_3(Form1.gstruct42_0, int_0);
							if (!Class11.bool_0 && num8 >= 0 && Form1.gstruct42_0[num8].bool_36 && Form1.gstruct42_0[num8].bool_61)
							{
								array3 = new uint[2]
								{
									Class20.smethod_30(num12 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_58.uint_0, gStruct.int_130),
				...
				default:
					...
					while (true)
					{
						if (Form1.int_98 > 3)
						{
							...
							Form1.gstruct42_0[num8].bool_61 = false;
							return;
						}
						flag = true;
