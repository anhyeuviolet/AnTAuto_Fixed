...
public class FormPhimtat : Form
{
	...
	private void FormPhimtat_Load(object sender, EventArgs e)
	{
		...
		comboBoxKieuPhimtat.Text = string_0[Form1.int_18];
		checkBoxLuonGanKetHop.Checked = (Form1.int_17 > 0);
	...
	private void checkBoxLuonGanKetHop_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_17 = Convert.ToByte(checkBoxLuonGanKetHop.Checked);
			Class55.smethod_10(Class47.string_0, "flagLuonGanPhimtat", Form1.int_17, "", 0);
		}
	}
	...
	private void comboBoxKieuPhimtat_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.int_18 = num;
		Class55.smethod_10(Class47.string_0, "flagKieuPhimTat", Form1.int_18, "", 0);
	}
	...
	private void buttonGanPhimALL_Click(object sender, EventArgs e)
	{
		if (Form1.gstruct42_0 != null)
		{
			...
			{
				Class60.smethod_14(Form1.gstruct42_0[i], Form1.int_18 > 0);
			}
		}
	}
}
