...
public class FormVideoHelp : Form
{
	...
	private void FormVideoHelp_Load(object sender, EventArgs e)
	{
		...
		checkBoxKhongHienthi.Checked = (Form1.int_10 > 0);
	...
	private void checkBoxKhongHienthi_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_10 = Convert.ToByte(checkBoxKhongHienthi.Checked);
			Class55.smethod_10(Class47.string_0, "KhongHienThiVideoHelp", Form1.int_10, "", 0);
			if (Form1.int_10 > 0)
			{
	...
	private void buttonHelp_Click(object sender, EventArgs e)
	{
		...
		if (Form1.string_6 != null && Form1.string_6 != string.Empty)
		{
			text = text + "|==============================================|PHIÊN BẢN MỚI:||" + Form1.string_6;
		}
		FormTip.smethod_0(Form1.string_1, text, 600000, 450, 540, bool_5: false, base.Left, base.Top);
	}
