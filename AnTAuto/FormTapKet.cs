...
public class FormTapKet : Form
{
	...
	public static int smethod_1(int int_5)
	{
		...
		{
			Thread.Sleep(120);
			int num8 = Class71.smethod_3(Form1.gstruct42_0, int_5);
			uint num12;
			int num15;
			string[] array5;
			int num18;
			if (!Class11.bool_0 && num8 >= 0 && Form1.int_107 > 0 && Form1.int_20 == 0 && gstruct51_0 != null && Class47.long_0 >= GClass1.long_1)
			{
				gStruct = Form1.gstruct42_0[num8];
	...
	private void comboBoxChon_MouseDown(object sender, MouseEventArgs e)
	{
		...
		if (int_0 > 0)
		{
			...
			if (0 <= num)
			{
				Class86.smethod_25(Form1.gstruct42_0[num], ref gstruct19_0, 3);
			}
		}
		if (gstruct19_0 == null && Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				Class86.smethod_25(Form1.gstruct42_0[i], ref gstruct19_0, 3);
			}
		}
