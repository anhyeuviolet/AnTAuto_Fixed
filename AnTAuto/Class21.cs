...
internal class Class21
{
	...
	public void method_0()
	{
		...
		{
			Thread.Sleep(300);
			num3 = Class71.smethod_3(Form1.gstruct42_0, num);
			if (Class11.bool_0 || num3 < 0 || !Form1.gstruct42_0[num3].bool_36 || Form1.gstruct42_0[num3].byte_0[0] == 0)
			{
				break;
			}
			...
			if (!flag)
			{
				...
				if (0 <= num3)
				{
					Form1.gstruct42_0[num3].bool_21 = true;
				}
			...
			while (true)
			{
				...
				if (0 <= num3)
				{
					Form1.gstruct42_0[num3].byte_0[num15] = 0;
					flag2 = false;
				}
				break;
			}
		...
		if (0 <= num3)
		{
			...
			Form1.gstruct42_0[num3].byte_0 = new byte[11];
			Form1.gstruct42_0[num3].byte_0[10] = 1;
			Form1.gstruct42_0[num3].bool_21 = false;
		}
	}
	...
	public void method_1()
	{
		...
		while (true)
		{
			...
			if (num2 <= 0)
			{
				...
				{
					Form1.gstruct42_0[num3].bool_10 = true;
		...
		if (0 <= num3)
		{
			Form1.gstruct42_0[num3].bool_10 = false;
			if (flag2)
			{
				Class39.smethod_12(gstruct42_);
			}
