...
internal class Class76
{
	...
	private static int smethod_8(GStruct42 gstruct42_0, string string_0, bool bool_0 = false, bool bool_1 = false, bool bool_2 = false, bool bool_3 = false)
	{
		...
		while (true)
		{
			...
			num4++;
            // DEBUG FULL
            //Class60.smethod_50(gstruct42_0, "num10=" + num10 + " num5=" + num5, 1);
            //Class60.smethod_50(gstruct42_0, "Click index=" + (num10 + num5), 1);
            //Class60.smethod_50(gstruct42_0, "Text: " + array[num10], 1);
            // DEBUG END

            //Class60.smethod_57(gstruct42_0, num10 + num5 - 1, num); // NGUYEN BAN: OFFSET -1 so vơi hien thi. Khong hieu vi sao va gay loi THP, Xa Phu
            Class60.smethod_57(gstruct42_0, num10 + num5, num);
			if (!bool_2)
			{
				num9 = 0;
