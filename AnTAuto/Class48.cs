...
internal class Class48
{
	public static void smethod_0(int int_0)
	{
		...
		{
			Thread.Sleep(200);
			num19 = Class71.smethod_3(Form1.gstruct42_0, int_0);
			if (Class11.bool_0 || num19 < 0 || Form1.int_20 != 0)
			{
				break;
			}
			gStruct = Form1.gstruct42_0[num19];
			...
			if (!gStruct.bool_21 && !gStruct.bool_14 && !gStruct.bool_6)
			{
				...
				if (gStruct.bool_27)
				{
					Form1.gstruct42_0[num19].bool_27 = false;
					flag3 = false;
				}
				if (Class38.bool_0 && gStruct.bool_37)
				{
					Form1.gstruct42_0[num19].bool_37 = false;
				...
				if (num31 != 0 && num30 != 0 && num32 != 0 && num35 > 1)
				{
					if (num30 != 10 && num30 != 21)
					{
						...
						if (num == num32 && (num2 == Class38.gstruct29_0.int_4 || Form1.int_21 <= 0))
						{
							if (num3 != num33)
							{
								num14 = 0;
							...
							if (gStruct.bool_29)
							{
								...
								if (0 <= num19)
								{
									Form1.gstruct42_0[num19].bool_29 = flag12;
								}
								if (!flag12)
								{
									Class11.smethod_22();
							...
							{
								if (num40 <= 180 && num20 < Form1.int_51)
								{
									num20 = Form1.int_51;
								}
								if (gStruct.int_123[0] > 0 && Form1.int_27 > 0 && num20 > 180)
								{
									num20 = 180;
								}
							}
							...
							if (gStruct.bool_1 && (flag3 || num33 > 0) && num15 != gStruct.int_0)
							{
								...
								if (0 <= num19)
								{
									Form1.gstruct42_0[num19].bool_29 = false;
								}
								continue;
							}
							if (Class38.gstruct29_0.int_0 == gStruct.int_129)
							...
							if (num33 <= 0)
							{
								...
								if (gStruct.int_126[0] <= 0 && (!flag3 || num4 < 0 || num4 != num45))
								{
									if (!Form1.bool_3)
									{
										...
										int num46 = Class30.smethod_1(gStruct, Form1.int_92 <= 0);
							...
							else
							{
								...
								flag3 = false;
								flag8 = true;
								if (((Form1.int_108 > 0 && num32 != 959) || (gStruct.int_100[0] > 0 && gStruct.int_100[1] <= num38)) && !Class53.smethod_13(gStruct) && gStruct.bool_63)
								{
							...
							if (Form1.int_107 > 0 && num33 <= 0 && FormTapKet.gstruct51_0 != null)
							{
								int num56 = 0;
							...
							bool flag18 = gStruct.int_120 != null && gStruct.int_120.Length > 4 && (Form1.int_70 > 0 || gStruct.int_120[0] > 0) && gStruct.int_120[2] > 0 && gStruct.int_120[3] > 0 && gStruct.int_120[4] > 0;
							bool flag19 = (Form1.int_6 > 0 || Form1.int_7 > 0) && (Form1.int_70 > 0 || gStruct.int_120[0] > 0) && Class38.gstruct29_1.int_11 != null && Class38.gstruct29_1.int_11[0] > 0 && Class38.gstruct29_1.int_11[1] > 0 && Class38.gstruct29_1.int_11[2] > 0 && Class38.gstruct29_1.int_11[3] > 0;
							if ((flag20 = (flag18 || flag19)) && (!flag11 || Form1.int_71 <= 0) && Class47.long_0 >= GClass1.long_1)
							{
								...
								if (num32 != num57)
								{
									if (Form1.int_80 > 0 || !gStruct.bool_63)
									{
										if (bool_)
										{
											bool_ = false;
							...
							if (Form1.int_108 > 0 && num32 != 959 && num32 != 990)
							{
								...
								if (num16 < 5 && gStruct.bool_63)
								{
									...
									{
										Form1.gstruct42_0[num19].bool_29 = true;
										continue;
									}
								}
								if (num33 <= 0)
							...
							flag21 = false;
							if ((flag16 = ((!gStruct.bool_1 || gStruct.int_0 < 0 || FormChayBoss.string_2.GetLength(0) <= gStruct.int_0 || FormChayBoss.string_2[gStruct.int_0, 0][0] == '.' || (Class38.gstruct29_0.int_4 == num32 && Class38.gstruct29_0.int_3 > 0 && !Class38.gstruct29_0.bool_1)) && Form1.int_21 > 0 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_6 > 0 && Class11.smethod_57(Class38.gstruct29_0.uint_4) && (Form1.int_22 > 0 || Class38.gstruct29_0.int_3 > 0))) && gStruct.int_129 != Class38.gstruct29_0.int_0)
							{
								if (Class38.gstruct29_0.int_4 == num32)
								{
									...
									num5 = 0;
									if (Form1.int_22 > 0 && Class38.gstruct29_0.int_3 <= 0 && num33 <= 0 && Class11.smethod_2(Class38.gstruct29_0.string_1, "m b\u00b8o d") > 0)
									{
										long num64 = 0L;
										long num65 = 0L;
										array4 = new uint[2]
									...
									num24 = 0;
									int_2 = 0;
									if (num33 > 0 && !gStruct.bool_33 && gStruct.bool_64 && gStruct.int_90 == 1 && Form1.int_96 > 0 && (Form1.int_31 > 0 || Form1.int_30 > 0 || Form1.int_32 > 0) && Class20.smethod_30(num29 + Class47.gstruct43_44.uint_0, gStruct.int_130) != 0 && Class20.smethod_30(num29 + Class47.gstruct43_43.uint_0, gStruct.int_130) != 0 && Class11.smethod_23(long_) > 600L)
									{
										Class60.smethod_55(gStruct, "Switch([[horse]])");
										long_ = Class11.smethod_22();
									}
									if (num13 <= 0L || Class11.smethod_23(num13) >= 1500L)
									{
										...
										num13 = 0L;
										if (num21 == 0 && Class53.smethod_18(uint_9, Class38.gstruct29_0.uint_4) > Form1.int_23 * Form1.int_23)
										{
											num11++;
											if (num11 > 3)
											{
										...
										if (Form1.int_27 > 0 && num33 > 0 && gStruct.int_123[0] > 0 && Class60.smethod_3(gStruct, Class60.uint_13) == 0)
										{
								...
								if (Form1.int_108 <= 0)
								{
									...
									else
									{
										...
										else
										{
											...
											if (flag13 || (Form1.int_22 <= 0 && Class38.gstruct29_0.int_3 <= 0))
											{
												flag21 = true;
												flag16 = false;
												goto IL_3432;
											}
											if (Class38.gstruct29_0.int_4 == 333 && Form1.string_3 == "vltrungnguyen.com" && Class50.smethod_1(num32) == null)
											{
												num44 = -1L;
												int num74 = -1;
														...
														else
														{
															if (num5 < 3 && gStruct.bool_63 && Class31.smethod_61(gStruct, Class38.gstruct29_0.int_4, null, Class38.gstruct29_0.uint_4))
															{
																...
																if (num32 == 195)
																{
																	try
																	{
																		num19 = Class71.smethod_3(Form1.gstruct42_0, gStruct.int_129);
																		if (0 <= num19)
																		{
																			Form1.gstruct42_0[num19].bool_29 = true;
																		}
												...
												if (num33 == 0 && Class38.gstruct29_0.int_3 > 0)
												{
													if (Form1.int_80 > 0 || !gStruct.bool_63)
													{
														if (bool_)
														{
															bool_ = false;
															uint[] uint_11 = null;
															if (Form1.int_21 > 0 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_4 == num32)
															{
					...
					if (gStruct.int_91 <= 0 && (Form1.int_38 <= 0 || Form1.int_37 <= 0))
					{
						num14 = 0;
					}
					flag10 = true;
			...
			if (num44 > Form1.int_95 * Form1.int_95)
			{
			...
			array11 = Class53.smethod_7(num32);
			if (array11 != null && num33 > 0 && Class38.gstruct29_0.int_3 <= 0 && Form1.int_22 > 0 && ((gStruct.bool_63 && Class31.smethod_61(gStruct, Class38.gstruct29_0.int_4, null, Class38.gstruct29_0.uint_4)) || Class53.smethod_13(gStruct)))
			{
				continue;
			}
			bool flag25 = num33 <= 0 && array11 != null && Class38.gstruct29_0.int_3 > 0;
			if (Form1.int_80 > 0 && bool_ && flag25)
			{
				bool_ = false;
				array4 = new uint[2]
				{
			...
			if (gStruct.bool_63 && num32 == 333 && num44 > 15354505L && Form1.string_3 == "vltrungnguyen.com")
			{
				num44 = -1L;
				int num74 = -1;
				for (int j = 0; j < Class37.gstruct19_0.Length; j++)
			...
			if (num81 != 0 && gStruct.int_129 != Class66.gstruct42_0.int_129)
			{
				...
				{
					uint[] array21 = Class53.smethod_3(uint_13, array19, -1 * (Form1.int_23 - 50));
			...
			if (Form1.int_93 != 0)
			{
				if (Class38.gstruct29_0.int_7 == Class24.gstruct38_0[Form1.int_94].int_0)
				{
			...
			IL_3432:
			flag14 = false;
			flag17 = ((Form1.int_6 > 0 || Form1.int_7 > 0) && Form1.int_21 > 0 && (Class38.gstruct29_1.int_3 > 0 || Form1.int_22 > 0) && Class38.gstruct29_1.int_4 > 0 && Class11.smethod_57(Class38.gstruct29_1.uint_4) && (gStruct.int_129 == Class38.gstruct29_0.int_0 || Class38.gstruct29_0.int_0 <= 0));
			array4 = new uint[2]
			{
				Class20.smethod_30(num29 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_58.uint_0, gStruct.int_130),
				Class20.smethod_30(num29 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_59.uint_0, gStruct.int_130)
			...
			if (flag21)
			{
				...
				if (flag17)
				{
					...
					if (num33 > 0 && num87 == 4L && Form1.int_96 > 0 && gStruct.int_90 == 1)
					{
			...
			flag3 = false;
			flag2 = false;
			flag15 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0));
			...
			if (flag15)
			{
				if (!Class38.smethod_6(gStruct, ref int_7) && Class73.smethod_12(gStruct) != 1)
				{
					...
					num55 = 0u;
					if (Form1.int_33 > 0 && (flag17 || flag16))
					{
						if (!flag17)
						{
			...
			else if (flag15 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0)))
			{
				...
				if (array23 != null)
				{
					...
					while (true)
					{
						...
						if (Form1.int_50 > 0 && (num41 <= 0 || num41 == array2[0]) && array2[1] > 0 && array2[2] == num32 && array2[3] > 0)
						{
							int num112 = array2[0];
							int num113 = array2[1];
							int num114 = array2[4];
