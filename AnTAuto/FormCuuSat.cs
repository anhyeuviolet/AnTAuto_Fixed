...
public class FormCuuSat : Form
{
	...
	{
		if (!bool_1 || string_0 == null || comboBoxThemAcc.Text == "" || Form1.gstruct42_0 == null || Form1.gstruct42_0.Length == 0)
		{
			return;
		}
		...
		if (num >= 0)
		{
			...
			for (int i = 0; i < string_0.Length; i++)
			{
				...
				{
					Class11.smethod_24(ref Form1.gstruct42_0[num].string_16, string_0[i]);
	...
	private void buttonXoaAcc_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			if (Form1.gstruct42_0[num].string_16 != null)
			{
				for (int i = 0; i < Form1.gstruct42_0[num].string_16.Length; i++)
				{
					if (text == Class10.smethod_1(Form1.gstruct42_0[num].string_16[i], 1))
					{
						Class11.smethod_25(ref Form1.gstruct42_0[num].string_16, Form1.gstruct42_0[num].string_16[i]);
						break;
					}
				}
			}
	...
	private void checkBoxCuusatTheoDs_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			Form1.gstruct42_0[num].int_117 = Convert.ToByte(checkBoxCuusatTheoDs.Checked);
		}
		else
		{
			bool_0 = false;
