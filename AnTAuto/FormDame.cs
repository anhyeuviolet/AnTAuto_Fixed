...
public class FormDame : Form
{
	...
	private void FormDame_Load(object sender, EventArgs e)
	{
		...
		bool enabled = false;
		int num3 = Class71.smethod_3(Form1.gstruct42_0, int_9);
		if (0 <= num3)
		{
			GStruct42 gstruct42_ = Form1.gstruct42_0[num3];
			comboBoxTenAc.Text = Class10.smethod_1(Form1.gstruct42_0[num3].string_20, 1);
	...
	private void comboBoxTenAc_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				...
				{
					int_9 = Form1.gstruct42_0[i].int_129;
					break;
				}
			}
		}
		int num = Class71.smethod_3(Form1.gstruct42_0, int_9);
		if (num >= 0)
		{
	...
	private void checkBoxSudungChieu12_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_121[0] = Convert.ToByte(checkBoxSudungChieu12.Checked);
				GStruct42 gstruct42_ = Form1.gstruct42_0[num];
	...
	private void checkBoxSkill1_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_121[1] = Convert.ToByte(checkBoxSkill1.Checked);
	...
	private void checkBoxSkill2_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_121[3] = Convert.ToByte(checkBoxSkill2.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void comboBoxSkill1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].int_121[2] = num2;
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
	...
	private void comboBoxSkill2_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].int_121[4] = num2;
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
