...
public class ThemXoaDanhsach : Form
{
	...
	private void ThemXoaDanhsach_Load(object sender, EventArgs e)
	{
		...
		if (Form1.string_19 != null && Form1.string_19.Length > 0)
		{
			for (int i = 0; i < Form1.string_19.Length; i++)
			{
				method_1(listViewOff, Form1.string_19[i]);
			}
	...
	private void method_0()
	{
		...
		{
			gstruct23_1 = new GStruct23[Form1.gstruct42_0.Length];
			for (int i = 0; i < gstruct23_1.Length; i++)
			{
				gstruct23_1[i].int_0 = Form1.gstruct42_0[i].int_129;
				gstruct23_1[i].int_1 = Class20.OpenProcess(2035711, bool_0: false, gstruct23_1[i].int_0);
				gstruct23_1[i].string_0 = Form1.gstruct42_0[i].string_20;
			}
		}
	...
	private void method_2(ListView listView_0, GStruct23 gstruct23_2)
	{
		...
		listView_0.Items.Add(listViewItem);
		if (Form1.int_52 == gstruct23_2.int_0 || Form1.string_14 == gstruct23_2.string_0 || Form1.string_14 == Class10.smethod_1(gstruct23_2.string_0, 1))
		{
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (Form1.string_19 != null && Form1.string_19.Length > 0)
		{
			for (int i = 0; i < Form1.string_19.Length; i++)
			{
				if (Class10.smethod_1(Form1.string_19[i], 1) == text)
				{
					text = Form1.string_19[i];
					Class11.smethod_25(ref Form1.string_19, text);
					break;
				}
			}
		}
		...
		if (Form1.string_19 != null && Form1.string_19.Length > 0)
		{
			for (int i = 0; i < Form1.string_19.Length; i++)
			{
				text2 = ((text2 != string.Empty) ? (text2 + "|" + Form1.string_19[i]) : Form1.string_19[i]);
			}
