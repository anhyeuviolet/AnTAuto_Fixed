...
public class FormPT : Form
{
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, gstruct42_0.int_129);
		if (0 <= num)
		{
			Form1.gstruct42_0[num].string_17 = gstruct42_0.string_17;
			Form1.gstruct42_0[num].int_118 = gstruct42_0.int_118;
	...
	private void buttonApdungAll_Click(object sender, EventArgs e)
	{
		...
		{
			if (Form1.gstruct42_0[i].int_129 == gstruct42_0.int_129)
			{
				continue;
			}
			Form1.gstruct42_0[i].string_17 = null;
			if (gstruct42_0.int_118 != null)
			{
				int num = 0;
				if (Form1.gstruct42_0[i].int_118 != null)
				{
					num = Form1.gstruct42_0[i].int_118[1];
				}
				else
				{
					Form1.gstruct42_0[i].int_118 = new int[gstruct42_0.int_118.Length];
				}
				for (int j = 0; j < gstruct42_0.int_118.Length; j++)
				{
					Form1.gstruct42_0[i].int_118[j] = gstruct42_0.int_118[j];
				}
				Form1.gstruct42_0[i].int_118[1] = num;
			}
			if (gstruct42_0.string_17 != null)
			{
				Form1.gstruct42_0[i].string_17 = new string[gstruct42_0.string_17.Length];
				for (int j = 0; j < gstruct42_0.string_17.Length; j++)
				{
					Form1.gstruct42_0[i].string_17[j] = gstruct42_0.string_17[j];
				}
			}
	...
	private void buttonAllAc_Click(object sender, EventArgs e)
	{
		...
		{
			listView1.Items.Clear();
			gstruct42_0.string_17 = new string[Form1.gstruct42_0.Length];
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				gstruct42_0.string_17[i] = Form1.gstruct42_0[i].string_20;
				method_0(listView1, Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1));
			}
		}
	}
