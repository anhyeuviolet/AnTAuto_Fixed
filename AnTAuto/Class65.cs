...
internal class Class65
{
	...
	public static void smethod_0()
	{
		...
		{
			Thread.Sleep(300);
			if (int_1 != null && Form1.bool_2 && !Form1.bool_0 && Form1.int_3 <= Form1.int_2)
			{
	...
	private static void smethod_1()
	{
		...
		while (true)
		{
			try
			{
				num2 = Class71.smethod_3(Form1.gstruct42_0, num);
				if (Class11.bool_0 || num2 < 0 || !Form1.gstruct42_0[num2].bool_36)
				{
					if (0 <= num2)
					{
						Form1.gstruct42_0[num2].bool_39 = false;
					}
					return;
				}
				if (num3 > 0)
				{
					Class47.smethod_11(Form1.gstruct42_0[num2]);
					num3 = 0;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num2].bool_39)
					{
						return;
					}
					Form1.gstruct42_0[num2].bool_39 = true;
					flag = true;
				}
				Form1.gstruct42_0[num2].bool_22 = false;
				Form1.gstruct42_0[num2].int_125[0] = 0;
				Form1.gstruct42_0[num2].bool_6 = false;
				gStruct = Form1.gstruct42_0[num2];
				if (!gStruct.bool_4)
				{
					Class60.smethod_50(gStruct, "-------------------------------------------");
					Class60.smethod_50(gStruct, "<color=yellow>" + Form1.string_1.ToUpper() + " FOR PRIVATE GAME");
		...
		while (true)
		{
			try
			{
                ...
                if (Class11.bool_0 || num < 0)
                {
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_38 = false;
						GStruct42 gstruct42_ = Form1.gstruct42_0[num];
						Class60.smethod_50(gstruct42_, "-------------------------------------------");
						Class60.smethod_50(gstruct42_, "<color=yellow>" + Form1.string_1.ToUpper() + " FOR PRIVATE GAME");
				...
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_38)
					{
						return;
					}
					flag = true;
					Form1.gstruct42_0[num].bool_38 = true;
					Class11.smethod_24(ref Class11.string_14, "[" + Class10.smethod_1(Form1.gstruct42_0[num].string_20, 1) + "] đang chạy.");
				}
				smethod_3(int_);
			}
			catch
	...
	private static void smethod_3(int int_5)
	{
		...
		{
			Thread.Sleep(200);
			num12 = Class71.smethod_3(Form1.gstruct42_0, int_5);
			...
			if (flag2)
			{
				Form1.gstruct42_0[num12].gstruct40_0 = gStruct.gstruct40_0;
				flag2 = false;
			}
			gStruct = Form1.gstruct42_0[num12];
			...
			if (num19 > 0 && num18 > 0 && Class11.smethod_23(long_2) > num3)
			{
				...
				if (GClass1.string_2 != null && !(GClass1.string_2 == string.Empty))
				{
					if (!flag)
					{
						if (Form1.bool_0 || Form1.int_3 > Form1.int_2)
						{
							break;
						}
						goto IL_021c;
			...
			goto IL_03a5;
			IL_021c:
			int num21 = GClass1.smethod_5(gStruct);
			if (num21 <= 0)
			{
				...
				if (0 <= num12)
				{
					//Form1.gstruct42_0[num12].bool_36 = false;
				}
				if (num21 == -10)
				{
					//Class60.smethod_50(gStruct, Class11.smethod_1(Class11.char_32));
				}
				else if (num21 >= 0)
				{
					//Class60.smethod_50(gStruct, Class11.smethod_1(Class11.char_38));
				}
				else
				{
					//Class60.smethod_50(gStruct, Class11.smethod_1(Class11.char_39));
				}
				//return;
			}
			if (!flag)
			{
				...
				if (Form1.int_17 > 0 || Form1.int_6 > 0 || Form1.int_7 > 0)
				{
					Class60.smethod_14(gStruct, Form1.int_18 > 0);
				}
			}
			num3 = 180000;
			...
			goto IL_03a5;
			IL_03a5:
			if (flag && Class47.int_0 > 0 && !Form1.bool_1 && (!Class26.bool_0 || Class11.long_0 < GClass1.long_1))
			{
			...
			if (num19 != 0 && num18 != 0 && num18 != 10 && num18 != 21 && num26 > 1)
			{
				...
				if (!flag4)
				{
					...
					if ((flag6 && (flag7 || Class11.smethod_23(long_8) > 10000L)) || num9 > 4)
					{
						...
						Form1.gstruct42_0[num12].bool_63 = (num30 > 0);
						Form1.gstruct42_0[num12].bool_64 = (num29 > 0);
					...
					if ((Form1.int_6 > 0 || Form1.int_7 > 0) && (Form1.int_52 <= 0 || Class38.gstruct29_0.int_0 <= 0))
					{
						if (Form1.int_6 <= 0 && Form1.int_7 > 0)
						{
					...
					if (Class11.smethod_23(long_) > 90000L)
					{
						...
						Class60.smethod_2(gStruct, Class60.uint_13, 0, 4);
						Form1.gstruct42_0[num12].string_18 = Class23.smethod_3(gStruct);
						...
						if (gStruct.string_21 == "NGAMY")
						{
							...
							Form1.gstruct42_0[num12].int_97[1] = num32;
							Form1.gstruct42_0[num12].int_97[5] = num33;
						}
						if (!gStruct.bool_65 && gStruct.string_21 == "VODANG")
						{
							int num34 = Class67.smethod_15(gStruct, 716u);
							Form1.gstruct42_0[num12].bool_65 = (num34 > 0);
							if (num34 < 1)
							{
								num34 = 1;
							}
							...
							Form1.gstruct42_0[num12].long_7 = Class47.int_3[num34 - 1];
						}
						if (!gStruct.bool_66 && gStruct.string_21 == "THIENNHAN")
						{
							int num34 = Class67.smethod_15(gStruct, 715u);
							Form1.gstruct42_0[num12].bool_66 = (num34 > 0);
							if (num34 < 1)
							{
								num34 = 1;
							}
						...
						if (gStruct.int_3 != null)
						{
							for (int num23 = 0; num23 < gStruct.int_3.Length; num23++)
							{
								...
								{
									Form1.gstruct42_0[num12].int_3[num23] = 0;
								}
							}
					...
					if (Form1.int_20 == 0)
					{
						...
						if (num36 <= 0)
						{
							...
							{
								if (Form1.int_21 > 0 && Form1.int_79 > 0)
								{
									...
									num37 = -1;
									bool flag8 = (Form1.int_6 > 0 || Form1.int_7 > 0) && Class38.gstruct29_1.int_4 == num28 && Class11.smethod_57(Class38.gstruct29_1.uint_4) && Class53.smethod_18(uint_, Class38.gstruct29_1.uint_4) < 1000000L;
									bool flag9 = Form1.int_6 <= 0 && Form1.int_7 <= 0 && Class38.gstruct29_0.int_4 == num28 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class11.smethod_57(Class38.gstruct29_0.uint_4) && Class53.smethod_18(uint_, Class38.gstruct29_0.uint_4) < 1000000L;
					...
					if (Form1.int_55 > 0 && (Form1.int_59 > 0 || num27 > 0))
					{
						if (num <= 0L)
						{
							num = DateTime.Now.Ticks - Form1.int_78 * 1000 + 3000L;
						}
						if (Class11.smethod_23(num) >= Form1.int_78 * 1000 && Class60.smethod_3(gStruct, Class60.uint_5) <= 0)
						{
							int num38 = 0;
							uint num39 = 0u;
							while (true)
							{
								...
								GStruct28[] array5 = Class53.smethod_12(gStruct, gstruct46_, Form1.int_60[0], Form1.int_60[1]);
								if (num38 > 0)
								{
								...
								if (Form1.int_77 > 0)
								{
									if ((!gStruct.bool_63 || !Class31.smethod_61(gStruct, "Ph­îng T­êng", "trung t©m")) && !Class53.smethod_13(gStruct) && Form1.int_75 > 0)
									{
										Class11.smethod_24(ref Class11.string_14, "FORM:Nhân vật [" + Class10.smethod_1(gStruct.string_20, 1) + "] đã thoát do có trang bị độ bền <= " + Form1.int_76 + ", hãy nhanh chóng sửa chữa.");
					...
					if (num27 > 0)
					{
						...
						if (Form1.int_14 > 0 || Form1.int_16 > 0)
						{
			...
			if (num26 > 1)
			{
				...
				if (gStruct.int_91 <= 0 && (Form1.int_38 <= 0 || Form1.int_37 <= 0) && num53 > 10000L)
				{
	...
	private static void smethod_4()
	{
		...
		while (true)
		{
			...
			{
				Thread.Sleep(500);
				int num2 = Class71.smethod_3(Form1.gstruct42_0, num);
				if (num2 < 0)
				{
					return;
				}
				if (Class11.bool_0 || !Form1.gstruct42_0[num2].bool_36 || Form1.gstruct42_0[num2].int_117 <= 0)
				{
					Form1.gstruct42_0[num2].bool_35 = false;
					Class60.smethod_50(gstruct42_, "<color=yellow>Cõu s\u00b8t theo danh s\u00b8ch: <color=green>T¾t");
					return;
				}
				gstruct42_ = Form1.gstruct42_0[num2];
				if (!gstruct42_.bool_35 || int_4 > 0)
				{
					Class60.smethod_50(gstruct42_, "<color=yellow>Cõu s\u00b8t theo danh s\u00b8ch: <color=green>BËt");
					Form1.gstruct42_0[num2].bool_35 = true;
					int_4 = 0;
				}
