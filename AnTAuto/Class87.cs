	...
	public static void smethod_0()
	{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || Form1.gstruct42_0[num].int_125[0] <= 0)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_52 = false;
						Form1.gstruct42_0[num].int_125[0] = 0;
						Class60.smethod_50(Form1.gstruct42_0[num], "<color=green>KÕt thóc nhÆt qu¶ !");
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_52)
					{
						return;
					}
					flag = true;
					Form1.gstruct42_0[num].bool_52 = true;
					Class60.smethod_50(Form1.gstruct42_0[num], "<color=green>NhÆt qu¶ Hoµng Kim...");
				}
				smethod_1(int_);
			}
			catch
