...
public class FormTuychon : Form
{
	...
	private void OnFormClosing(object sender, FormClosingEventArgs e)
	{
		if (int_1 <= 0)
		{
			...
			if (0 <= num)
			{
				Form1.gstruct42_0[num].int_80 = Convert.ToByte(checkBoxTheoThoigian.Checked);
	...
	private void FormTuychon_Load(object sender, EventArgs e)
	{
		...
		if (int_1 <= 0)
		{
			...
			if (0 <= num3)
			{
				GStruct42 gstruct42_ = Form1.gstruct42_0[num3];
		...
		else if (int_1 != 1)
		{
			if (int_1 == 2)
			{
				...
				tabControl1.Controls.Remove(tabPage7);
				tabControl1.Controls.Remove(tabPage8);
				checkBoxTutimMuctieu.Checked = (Form1.int_34 > 0);
				checkBoxBossTruocNguoiSau.Checked = (Form1.int_36 > 0);
				checkBoxChetNamImAll.Checked = (Form1.int_38 > 0);
				switch (num2)
				{
				case 1:
			...
			else if (int_1 != 5)
			{
				if (int_1 == 6)
				{
					...
					checkBoxMuaNoiChiendau.Checked = (Form1.int_29 > 0);
					richTextBoxLuuY.Enabled = (Form1.int_29 > 0);
					if (struct25_0 == null && Form1.gstruct42_0 != null)
					{
						for (int i = 0; i < Form1.gstruct42_0.Length; i++)
						{
							struct25_0 = Class73.smethod_1(Form1.gstruct42_0[i]);
							if (struct25_0 != null)
							{
								break;
							}
				...
				else if (int_1 == 7)
				{
					...
					checkBoxQuangThuoc.Checked = (Form1.int_27 > 0);
					checkBoxTDP.Checked = (Form1.int_28 > 0);
				}
			}
			else
			{
		...
		else
		{
			...
			comboBoxPhim.Text = Class24.gstruct38_0[Form1.int_94].string_0;
			checkBoxBamphim.Checked = (Form1.int_93 > 0);
			tabControl1.Controls.Remove(tabPage1);
			tabControl1.Controls.Remove(tabPage3);
			tabControl1.Controls.Remove(tabPage4);
			tabControl1.Controls.Remove(tabPage5);
	...
	private void checkBoxDinhbangsat_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_79 = Convert.ToByte(checkBoxDinhbangsat.Checked);
			}
		}
	}
	...
	private void textBoxGiaiBua_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_83 = Class11.smethod_12(textBoxGiaiBua.Text);
			}
		}
	}
	...
	private void textBoxThoigianGiaibua_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_85 = Class11.smethod_12(textBoxThoigianGiaibua.Text);
			}
		}
	}
	...
	private void buttonApdungAll_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			string a = Class67.smethod_18(Form1.gstruct42_0[i]);
			if (a != "VODANG")
			{
				continue;
			}
			int num = Class67.smethod_15(Form1.gstruct42_0[i], 716u);
			if (num > 0)
			{
				Form1.gstruct42_0[i].int_80 = int_2;
				Form1.gstruct42_0[i].int_79 = int_4;
				if (@checked)
				{
					Form1.gstruct42_0[i].int_83 = int_;
					Form1.gstruct42_0[i].int_85 = int_3;
				}
			}
		}
	...
	private void checkBoxBamphim_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_93 = Convert.ToByte(checkBoxBamphim.Checked);
			Class55.smethod_10(Class47.string_0, "flagTNBamPhim", Form1.int_93, "", 0);
			if (Form1.int_93 > 0 && Form1.int_61 <= 0)
			{
				Form1.int_61 = 1;
				GClass0.smethod_1();
				GClass0.smethod_0();
	...
	private void comboBoxPhim_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		{
			Form1.int_94 = num;
			Class55.smethod_10(Class47.string_0, "TNIdexPhim", Form1.int_94, "", 0);
		}
	}
	...
	private void checkBoxTutimMuctieu_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_34 = Convert.ToByte(checkBoxTutimMuctieu.Checked);
			Class55.smethod_10(Class47.string_0, "flagTutimMuctieu", Form1.int_34, "", 0);
		}
	}
	...
	private void checkBoxBossTruocNguoiSau_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_36 = Convert.ToByte(checkBoxBossTruocNguoiSau.Checked);
			Class55.smethod_10(Class47.string_0, "BossTruocNguoiSau", Form1.int_36, "", 0);
		}
	}
	...
	private void checkBoxChetNamImAll_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_38 = Convert.ToByte(checkBoxChetNamImAll.Checked);
			Class55.smethod_10(Class47.string_0, "fNamImONOFF", Form1.int_38, "", 0);
		}
	}
	...
	private void checkBoxMuaNoiChiendau_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_29 = Convert.ToByte(checkBoxMuaNoiChiendau.Checked);
			Class55.smethod_10(Class47.string_0, "fMuaNoiChiendau", Form1.int_29, "", 0);
			richTextBoxLuuY.Enabled = (Form1.int_29 > 0);
		}
	}
	...
	private void checkBoxQuangThuoc_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_27 = Convert.ToByte(checkBoxQuangThuoc.Checked);
			Class55.smethod_10(Class47.string_0, "fQuangThuocAchinh", Form1.int_27, "", 0);
		}
	}
	...
	private void checkBoxTDP_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			Form1.int_28 = Convert.ToByte(checkBoxTDP.Checked);
			Class55.smethod_10(Class47.string_0, "fQuangThuocTDP", Form1.int_28, "", 0);
		}
	}
}
