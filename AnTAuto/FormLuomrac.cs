...
public class FormLuomrac : Form
{
	...
	private void FormLuomrac_Load(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].int_57 = 0;
	...
	private void checkBoxBanTheoThuoctinh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_58 = Convert.ToByte(checkBoxBanTheoThuoctinh.Checked);
	...
	private void checkBoxAccept_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_57 = Convert.ToByte(checkBoxAccept.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void buttonPhichiendau_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			string text = Class10.smethod_1(Form1.gstruct42_0[num].string_20, 1) + ": " + Class47.string_3 + "Khi làm phi chiến đấu, ac phải lưu rương khác map. " + Class47.string_3 + "Ví dụ làm ở Mạc Cao Quật thì không được lưu rương Thành đô, ở Sa mạc 1, 2, 3 thì không được lưu rương Lâm an..." + Class47.string_3 + "Sau khi làm phi chiến đấu, ac sẽ tự thoát game và bạn phải log lại. Bạn chắc chắn muốn làm phi chiến đấu cho ac ?";
			if (MessageBox.Show(text, Form1.string_1, MessageBoxButtons.YesNo) != DialogResult.No)
			{
				Class53.smethod_28(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private static void smethod_1(int int_6)
	{
		...
		{
			Thread.Sleep(300);
			int num7 = Class71.smethod_3(Form1.gstruct42_0, int_6);
			if (Class11.bool_0 || num7 < 0 || !Form1.gstruct42_0[num7].bool_36 || Form1.gstruct42_0[num7].int_26 <= 0 || Form1.gstruct42_0[num7].int_56 <= 0 || Form1.gstruct42_0[num7].int_57 <= 0 || Form1.gstruct42_0[num7].int_33 <= 0)
			{
				break;
			}
			gStruct = Form1.gstruct42_0[num7];
			if (!flag)
			{
