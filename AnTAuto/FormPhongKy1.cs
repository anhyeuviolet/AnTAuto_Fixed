...
public class FormPhongKy1 : Form
{
	...
	private void OnFormClosing(object sender, FormClosingEventArgs e)
	{
		if (bool_2 || bool_1)
		{
			...
			if (0 <= num)
			{
				if (Form1.gstruct42_0[num].string_2 != null)
				{
					Class32.smethod_51(Form1.gstruct42_0[num], Form1.gstruct42_0[num].string_2);
				}
	...
	private void FormPhongKy1_Load(object sender, EventArgs e)
	{
		...
		GStruct42 gStruct = Form1.gstruct42_0[num];
		if (int_0 >= 0 && int_1 >= 0)
		{
	...
	private void method_1()
	{
		...
		{
			listViewPk1.Items.Clear();
			Form1.gstruct42_0[num].uint_2 = null;
		}
		Form1.gstruct42_0[num].int_36 = num2;
		...
		Class11.smethod_49(ref Form1.gstruct42_0[num].uint_2, array);
		method_0(listViewPk1, array);
		method_3(listViewPk1, listViewPk1.Items.Count - 1);
		Class47.smethod_11(Form1.gstruct42_0[num]);
		string string_ = "#" + (Form1.gstruct42_0[num].uint_2.GetLength(0) - 1) + " (" + array[0] + "," + array[1] + ")";
	...
	private void method_2()
	{
		...
		{
			listViewPk2.Items.Clear();
			Form1.gstruct42_0[num].uint_3 = null;
		}
		Form1.gstruct42_0[num].int_37 = num2;
		...
		Class11.smethod_49(ref Form1.gstruct42_0[num].uint_3, array);
		method_0(listViewPk2, array);
		method_3(listViewPk2, listViewPk2.Items.Count - 1);
		Class47.smethod_11(Form1.gstruct42_0[num]);
		string string_ = "##" + (Form1.gstruct42_0[num].uint_3.GetLength(0) - 1) + " (" + array[0] + "," + array[1] + ")";
		Class32.smethod_51(gstruct42_, string_);
	}
	...
	private void buttonOpenPathPk_Click(object sender, EventArgs e)
	{
		...
		int num = num = Class71.smethod_3(Form1.gstruct42_0, int_4);
		if (num < 0)
		{
			Close();
			return;
		...
		if (!(text3 == string.Empty))
		{
			...
			if (array.Length == 2)
			{
				...
				if (num2 != 0)
				{
					...
					{
						Form1.gstruct42_0[num].uint_2 = new uint[array2.Length, 2];
						for (int i = 0; i < array2.Length; i++)
						{
							...
							if (array3.Length == 2)
							{
								for (int j = 0; j < 2; j++)
								{
									Form1.gstruct42_0[num].uint_2[i, j] = Class11.smethod_13(array3[j]);
								}
							}
							method_0(listViewPk1, new uint[2]
							{
								Form1.gstruct42_0[num].uint_2[i, 0],
								Form1.gstruct42_0[num].uint_2[i, 1]
							});
						}
					}
					Class57.int_0 = Form1.gstruct42_0[num].int_129;
					return;
				}
			}
		}
		Form1.gstruct42_0[num].int_36 = 0;
		Form1.gstruct42_0[num].uint_2 = null;
		Class57.int_0 = Form1.gstruct42_0[num].int_129;
	}
	...
	private void buttonOpenPathPk2_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			if (!(text3 == string.Empty))
			{
				...
				if (array.Length == 2)
				{
					...
					if (num2 != 0)
					{
						...
						if (array2 != null && array2.Length > 0)
						{
							Form1.gstruct42_0[num].uint_3 = new uint[array2.Length, 2];
							for (int i = 0; i < array2.Length; i++)
							{
								string[] array3 = array2[i].Split(';');
								if (array3.Length == 2)
								{
									for (int j = 0; j < 2; j++)
									{
										Form1.gstruct42_0[num].uint_3[i, j] = Class11.smethod_13(array3[j]);
									}
								}
								method_0(listViewPk2, new uint[2]
								{
									Form1.gstruct42_0[num].uint_3[i, 0],
									Form1.gstruct42_0[num].uint_3[i, 1]
								});
							}
						}
						Class57.int_0 = Form1.gstruct42_0[num].int_129;
			...
			Form1.gstruct42_0[num].int_37 = 0;
			Form1.gstruct42_0[num].uint_3 = null;
			Class57.int_0 = Form1.gstruct42_0[num].int_129;
		}
		else
	...
	private void buttonWritePathPk_Click(object sender, EventArgs e)
	{
		...
		else if (!bool_2 && !bool_1)
		{
			...
			Form1.gstruct42_0[num].string_2 = Class32.smethod_50(Form1.gstruct42_0[num]);
			Class32.smethod_51(Form1.gstruct42_0[num], "BÊm Space ®Ó ghi ®­êng dÉn");
			GClass0.smethod_1();
			GClass0.smethod_0();
		}
	}
	...
	private void buttonWritePathPk2_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			if (!bool_1 && !bool_2)
			{
				...
				Form1.gstruct42_0[num].string_2 = Class32.smethod_50(Form1.gstruct42_0[num]);
				Class32.smethod_51(Form1.gstruct42_0[num], "BÊm Space ®Ó ghi to¹ ®é");
				GClass0.smethod_1();
				GClass0.smethod_0();
			}
		}
	...
	private void buttonStopWritePathPk_Click(object sender, EventArgs e)
	{
		...
		buttonStopWritePathPk.Enabled = false;
		if (bool_1 && Form1.gstruct42_0[num].string_2 != null)
		{
			Class32.smethod_51(Form1.gstruct42_0[num], Form1.gstruct42_0[num].string_2);
		}
		bool_1 = false;
	...
	private void buttonStopWritePathPk2_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			buttonStopWritePathPk2.Enabled = false;
			if (bool_2 && Form1.gstruct42_0[num].string_2 != null)
			{
				Class32.smethod_51(Form1.gstruct42_0[num], Form1.gstruct42_0[num].string_2);
			}
			bool_2 = false;
	...
	private void buttonXoaPk_Click(object sender, EventArgs e)
	{
		...
		if (listViewPk1.Items != null && listViewPk1.Items.Count > 0 && gStruct.uint_2 != null && gStruct.uint_2.GetLength(0) != 0)
		{
			...
			else
			{
				...
				{
					Class57.int_0 = Form1.gstruct42_0[num].int_129;
					Form1.gstruct42_0[num].uint_2 = new uint[num5, 2];
					for (int i = 0; i < num5; i++)
					{
						Form1.gstruct42_0[num].uint_2[i, 0] = array2[i, 0];
						Form1.gstruct42_0[num].uint_2[i, 1] = array2[i, 1];
					}
				}
				catch
				{
		...
		if (num >= 0)
		{
			...
			if (listViewPk2.Items != null && listViewPk2.Items.Count > 0 && gStruct.uint_3 != null && gStruct.uint_3.GetLength(0) != 0)
			{
				...
				if (num5 != 0)
				{
					...
					{
						Class57.int_0 = Form1.gstruct42_0[num].int_129;
						Form1.gstruct42_0[num].uint_3 = new uint[num5, 2];
						for (int i = 0; i < num5; i++)
						{
							Form1.gstruct42_0[num].uint_3[i, 0] = array2[i, 0];
							Form1.gstruct42_0[num].uint_3[i, 1] = array2[i, 1];
						}
					}
					catch
					{
