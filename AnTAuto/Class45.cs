...
internal class Class45
{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_41 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_41)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_41 = true;
					flag = true;
				}
				smethod_1(int_);
			}
	...
	private static void smethod_1(int int_1)
	{
		...
		while (true)
		{
			...
			if (num < 0)
			{
				num3 = Class71.smethod_3(Form1.gstruct42_0, int_1);
				if (Class11.bool_0 || num3 < 0 || !Form1.gstruct42_0[num3].bool_36)
				{
					break;
				}
				num = 10;
            ...
            if (Form1.gstruct42_0 == null ||
                num3 < 0 ||
                num3 >= Form1.gstruct42_0.Length ||
                Form1.gstruct42_0[num3].process_0 == null ||
                Form1.gstruct42_0[num3].process_0.HasExited)
            {
                break;
            }
            gStruct = Form1.gstruct42_0[num3];
