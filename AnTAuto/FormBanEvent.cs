...
public class FormBanEvent : Form
{
    ...
    public static void smethod_2()
    {
        ...
        while (true)
        {
            try
            {
                ...
                if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || Form1.gstruct42_0[num].int_11 <= 0)
                {
                    if (0 <= num)
                    {
                        Form1.gstruct42_0[num].bool_7 = false;
                        Class60.smethod_50(Form1.gstruct42_0[num], "<color=green>KÕt thóc b\u00b8n vËt phÈm trong danh s\u00b8ch !");
                    }
                    return;
                }
                if (!flag)
                {
                    if (Form1.gstruct42_0[num].bool_7)
                    {
                        return;
                    }
                    flag = true;
                    Form1.gstruct42_0[num].bool_7 = true;
                    Class60.smethod_50(Form1.gstruct42_0[num], "<color=green>§ang ch¹y b\u00b8n vËt phÈm trong danh s\u00b8ch (tab event - b\u00b8n)...");
                }
                smethod_4(int_);
            }
            catch
    ...
    private static void smethod_4(int int_5, bool bool_2 = false)
    {
        ...
        {
            Thread.Sleep(600);
            num = Class71.smethod_3(Form1.gstruct42_0, int_5);
