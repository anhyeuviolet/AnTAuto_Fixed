...
internal class Class61
{
	...
	public static void smethod_1(int int_0)
	{
		...
		{
			Thread.Sleep(400);
			num = Class71.smethod_3(Form1.gstruct42_0, int_0);
			if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_60)
			{
				break;
			}
			...
			if (flag)
			{
				...
				if (num4 < Form1.int_43 * 1000)
				{
					long num5 = Form1.int_43 - num4 / 1000L;
			...
			if (Form1.string_7 != null && !(Form1.string_7 == string.Empty))
			{
				...
				if (num15 <= 90000L)
				{
					...
					do
					{
						...
						while (true)
						{
							...
							Class60.smethod_101(gstruct42_, Form1.string_7);
							Class76.Class79.smethod_5(gstruct42_);
							Class76.Class79.smethod_1(gstruct42_);
							for (int i = 0; i < 2; i++)
							{
							...
							while (true)
							{
								...
								string text4 = null;
								string text5 = null;
								string text6 = "|" + Form1.string_7 + "| kh«ng râ tung tÝch n¬i ®©u.";
								try
								{
								...
								{
									text6 = "|" + Form1.string_7 + "| ë (" + text5 + ") " + text4;
								}
								if (Form1.gstruct42_0 != null)
								{
									for (int i = 0; i < Form1.gstruct42_0.Length; i++)
									{
										if (gstruct42_.string_20 != Form1.gstruct42_0[i].string_20)
										{
											Class60.smethod_48(gstruct42_, Form1.gstruct42_0[i].string_20, text6);
										}
									}
								}
								if (Form1.int_41 > 0)
