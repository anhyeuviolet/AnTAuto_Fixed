	...
	private static GStruct42 smethod_3()
	{
		if (Form1.gstruct42_0 != null)
		{
			...
			if (int_ > 0)
			{
				...
				{
					if (int_ == Form1.gstruct42_0[i].int_129)
					{
						return Form1.gstruct42_0[i];
					}
				}
			}
		}
		...
		while (true)
		{
			...
			if (0 > num)
			{
				...
				if (num4 >= 100)
				{
					num4 = 0;
					bool flag = true;
					if (Form1.gstruct42_0 != null && Form1.int_109 > 0)
					{
						for (int i = 0; i < Form1.gstruct42_0.Length; i++)
						{
							int num5 = Class33.smethod_0(Form1.gstruct42_0[i]);
			...
			int num9;
			if (!FormMayphu.bool_1 && Form1.gstruct42_0 != null && GClass1.gstruct14_0 != null && Class11.smethod_23(long_0) > 90000L)
			{
				int[] array2 = new int[Form1.gstruct42_0.Length];
				for (int i = 0; i < Form1.gstruct42_0.Length; i++)
				{
					array2[i] = Form1.gstruct42_0[i].int_129;
				}
				num9 = 0;
			...
			if (gstruct42_0.int_129 > 0)
			{
				...
				if (int_2 > 0 && Form1.gstruct42_0 != null)
				{
					for (int i = 0; i < Form1.gstruct42_0.Length; i++)
					{
							...
							if (int_1 != 6)
							{
								if (int_1 != 7)
								{
									if (int_1 == 8)
									{
										for (int i = 0; i < Form1.gstruct42_0.Length; i++)
										{
											if (Form1.gstruct42_0[i].bool_36 && Form1.gstruct42_0[i].int_123[0] > 0)
											{
												Class60.smethod_2(Form1.gstruct42_0[i], Class60.uint_13, 1, 4);
											}
										}
									}
								}
				...
				if (GClass0.int_1 == Class24.int_4 || bool_1)
				{
					...
					for (int i = 0; i < Form1.gstruct42_0.Length; i++)
					{
						...
						{
							Class60.smethod_2(Form1.gstruct42_0[i], Class60.uint_12, 1, 4);
						}
					}
				}
			}
