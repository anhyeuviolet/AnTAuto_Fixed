...
internal class Class36
{
	...
	private static void smethod_2(int int_2)
	{
		...
		while (true)
		{
			...
			gstruct42_ = Form1.gstruct42_0[num4];
			if (!flag2)
			{
				...
				flag2 = true;
				Form1.gstruct42_0[num4].bool_21 = true;
			...
			if (num9 != 0 && num8 != 0 && num8 != 10 && num8 != 21 && num10 != 0 && (int)array4[0] > 0 && (int)array4[1] > 0 && num11 > 1)
			{
				...
				if (num10 == 336)
				{
					array = new uint[2]
					{
						array3[Form1.int_98, 0],
						array3[Form1.int_98, 1]
					};
					array2 = new uint[2]
					{
						array3[Form1.int_98, 2],
						array3[Form1.int_98, 3]
					};
		...
		if (flag2)
		{
			...
			if (0 <= num4)
			{
				Form1.gstruct42_0[num4].bool_21 = false;
			}
		}
	}
}
