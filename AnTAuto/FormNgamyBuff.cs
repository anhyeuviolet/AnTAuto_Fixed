...
public class FormNgamyBuff : Form
{
	...
	private void checkBoxnttk_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			Form1.gstruct42_0[num].int_97[6] = Convert.ToByte(checkBoxnttk.Checked);
			Form1.gstruct42_0[num].int_97[1] = num2;
			Form1.gstruct42_0[num].int_97[5] = num3;
	...
	private void comboBoxNgaMyBuff_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].int_97[2] = num2;
		Class47.smethod_11(Form1.gstruct42_0[num]);
	}
