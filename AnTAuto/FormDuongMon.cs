...
public class FormDuongMon : Form
{
	...
	public static void smethod_0(GStruct42 gstruct42_0, ref int int_8, uint[] uint_0, ref int int_9, bool bool_2)
	{
		...
		do
		{
			...
			if (gstruct42_0.int_129 != Class38.gstruct29_0.int_0 || Form1.int_6 > 0 || Form1.int_7 > 0)
			{
	...
	private void FormDuongMon_Load(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				...
				if (a == "DUONGMON")
				{
					comboBoxTenAc.Items.Add(Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1));
					if (num3 <= 0)
					{
						num3 = Form1.gstruct42_0[i].int_129;
						gstruct42_ = Form1.gstruct42_0[i];
					}
				}
			}
		}
		if (int_4 > 0)
		{
			int num5 = Class71.smethod_3(Form1.gstruct42_0, int_4);
			if (0 <= num5)
			{
				string a = Class67.smethod_18(Form1.gstruct42_0[num5]);
				if (a == "DUONGMON")
				{
					num4 = Form1.gstruct42_0[num5].int_129;
					gstruct42_ = Form1.gstruct42_0[num5];
				}
			}
		}
		if (num4 <= 0 && num3 > 0)
	...
	private void checkBoxPhim1_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_122[1] = Convert.ToByte(checkBoxPhim1.Checked);
	...
	private void checkBoxPhim2_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_122[3] = Convert.ToByte(checkBoxPhim2.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void checkBoxPhim3_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_122[5] = Convert.ToByte(checkBoxPhim3.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void comboBoxTenAc_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				if (text == Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1))
				{
					int_4 = Form1.gstruct42_0[i].int_129;
					break;
				}
			}
		}
	...
	private void comboBoxBoom1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].int_122[2] = num2;
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
	...
	private void comboBoxBoom2_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].int_122[4] = num2;
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
	...
	private void comboBoxBoom3_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].int_122[6] = num2;
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
