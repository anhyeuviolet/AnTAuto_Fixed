...
public class Loaitru : Form
{
	...
	private void OnFormClosing(object sender, FormClosingEventArgs e)
	{
		...
		if (Class47.string_2 != null)
		{
			for (int i = 0; i < Class47.string_2.Length; i++)
			{
				...
				{
					if (Class47.string_2[i] == Form1.gstruct42_0[j].string_20)
					{
						Form1.gstruct42_0[j].bool_33 = true;
						break;
					}
				}
			}
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				...
				if (Class47.string_2 != null)
				{
					...
					{
						if (Class47.string_2[j] == Form1.gstruct42_0[i].string_20)
						{
							flag = true;
							break;
						}
				...
				if (!flag)
				{
					string item = Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1);
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			if (!(Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1) == text))
			{
				continue;
			}
			bool flag = false;
			...
			if (!flag)
			{
				Class11.smethod_24(ref Class47.string_2, Form1.gstruct42_0[i].string_20);
				Form1.gstruct42_0[i].bool_33 = true;
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[i].string_20, 1) == text)
				{
					Form1.gstruct42_0[i].bool_33 = false;
					break;
				}
			}
		}
