...
public class FormHaucanTuithuoc : Form
{
	...
	{
		bool flag = false;
		int num = Class71.smethod_3(Form1.gstruct42_0, int_0);
		if (0 <= num)
		{
			Class47.smethod_11(Form1.gstruct42_0[num]);
			flag = true;
		}
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				if (!flag)
				{
					Class47.smethod_11(Form1.gstruct42_0[i]);
				}
			}
		}
		int_2 = 0;
	...
	private void FormHaucanTuithuoc_Load(object sender, EventArgs e)
	{
		...
		textBoxSoluongMax.Text = Form1.int_12.ToString();
		checkBoxKhongMo.Checked = (Form1.int_13 > 0);
	...
	private void listView1_MouseUp(object sender, MouseEventArgs e)
	{
		...
		int num = Class71.smethod_3(Form1.gstruct42_0, int_1);
		if (num < 0 || Form1.gstruct42_0[num].gstruct30_0 == null)
		{
			return;
		}
		for (int i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
		{
			if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text)
			{
				method_1(Form1.gstruct42_0[num].gstruct30_0[i]);
			}
		}
	}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		comboBoxTenTuiMauHotro.Items.Clear();
		int num = Class71.smethod_3(Form1.gstruct42_0, int_1);
		if (num >= 0 && Form1.gstruct42_0[num].gstruct30_0 != null && Form1.gstruct42_0[num].gstruct30_0.Length > 0)
		{
			if (Form1.gstruct42_0[num].gstruct30_0.Length == 1)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[0].string_0, 1) == text)
				{
					Form1.gstruct42_0[num].gstruct30_0 = null;
					int_6 = -1;
					listView1.Items.Clear();
				}
				return;
			}
			GStruct30[] array = new GStruct30[Form1.gstruct42_0[num].gstruct30_0.Length];
			int num2 = 0;
			for (int i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (!(Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) != text))
				...
				array[num2].string_0 = Form1.gstruct42_0[num].gstruct30_0[i].string_0;
				array[num2].int_4 = Form1.gstruct42_0[num].gstruct30_0[i].int_4;
				array[num2].int_5 = Form1.gstruct42_0[num].gstruct30_0[i].int_5;
				array[num2].int_0 = Form1.gstruct42_0[num].gstruct30_0[i].int_0;
				array[num2].int_3 = Form1.gstruct42_0[num].gstruct30_0[i].int_3;
				array[num2].int_6 = Form1.gstruct42_0[num].gstruct30_0[i].int_6;
				array[num2].int_7 = Form1.gstruct42_0[num].gstruct30_0[i].int_7;
				if (Form1.gstruct42_0[num].gstruct30_0[i].int_8 != null)
				{
					array[num2].int_8 = new int[Form1.gstruct42_0[num].gstruct30_0[i].int_8.Length];
					for (int j = 0; j < Form1.gstruct42_0[num].gstruct30_0[i].int_8.Length; j++)
					{
						array[num2].int_8[j] = Form1.gstruct42_0[num].gstruct30_0[i].int_8[j];
					}
				}
				num2++;
			}
			...
			if (num2 == Form1.gstruct42_0[num].gstruct30_0.Length)
			{
				int_6 = 0;
				listView1.Items[int_6].Focused = true;
				listView1.Items[int_6].Selected = true;
				method_1(Form1.gstruct42_0[num].gstruct30_0[int_6]);
				return;
			}
			Form1.gstruct42_0[num].gstruct30_0 = new GStruct30[num2];
			for (int i = 0; i < num2; i++)
			{
				Form1.gstruct42_0[num].gstruct30_0[i].string_0 = array[i].string_0;
				Form1.gstruct42_0[num].gstruct30_0[i].int_4 = array[i].int_4;
				Form1.gstruct42_0[num].gstruct30_0[i].int_5 = array[i].int_5;
				Form1.gstruct42_0[num].gstruct30_0[i].int_0 = array[i].int_0;
				Form1.gstruct42_0[num].gstruct30_0[i].int_3 = array[i].int_3;
				Form1.gstruct42_0[num].gstruct30_0[i].int_6 = array[i].int_6;
				Form1.gstruct42_0[num].gstruct30_0[i].int_7 = array[i].int_7;
				if (array[i].int_8 != null)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_8 = new int[array[i].int_8.Length];
					for (int j = 0; j < array[i].int_8.Length; j++)
					{
						Form1.gstruct42_0[num].gstruct30_0[i].int_8[j] = array[i].int_8[j];
					}
				}
			}
	...
	private void checkBoxMoTheoSoluong_CheckedChanged(object sender, EventArgs e)
	{
		...
		int i;
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text2)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_4 = Convert.ToByte(checkBoxMoTheoSoluong.Checked);
					text = Form1.gstruct42_0[num].gstruct30_0[i].int_5.ToString();
					break;
				}
			}
		}
	...
	private void textBoxMothuocKhicon_TextChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text2)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_5 = Class11.smethod_12(textBoxMothuocKhicon.Text);
					text = Form1.gstruct42_0[num].gstruct30_0[i].int_5.ToString();
					break;
				}
			}
	...
	private void checkBoxMoTheoThoigian_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text2)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_0 = Convert.ToByte(checkBoxMoTheoThoigian.Checked);
					text = Form1.gstruct42_0[num].gstruct30_0[i].int_3.ToString();
					break;
				}
			}
		}
	...
	private void textBoxThoigian_TextChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text2)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_3 = Class11.smethod_12(textBoxThoigian.Text);
					text = Form1.gstruct42_0[num].gstruct30_0[i].int_3.ToString();
					break;
				}
			}
	...
	private void checkBoxClickMenu_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_7 = Convert.ToByte(checkBoxClickMenu.Checked);
					break;
				}
			}
		}
	...
	private void checkBoxCoNhapSoluong_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_6 = Convert.ToByte(checkBoxCoNhapSoluong.Checked);
					break;
				}
			}
		}
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < string_0.Length; i++)
		{
			if (Class10.smethod_1(string_0[i].Trim(), 1) == text)
			{
				...
				gstruct30_.int_8 = Form1.smethod_2(textBoxMenu.Text);
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null && Form1.gstruct42_0[num].gstruct30_0.Length != 0)
		{
			GStruct30[] array = new GStruct30[Form1.gstruct42_0[num].gstruct30_0.Length + 1];
			for (int i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (!(gstruct30_.string_0 == Form1.gstruct42_0[num].gstruct30_0[i].string_0))
				{
					array[i].string_0 = Form1.gstruct42_0[num].gstruct30_0[i].string_0;
					array[i].int_4 = Form1.gstruct42_0[num].gstruct30_0[i].int_4;
					array[i].int_5 = Form1.gstruct42_0[num].gstruct30_0[i].int_5;
					array[i].int_0 = Form1.gstruct42_0[num].gstruct30_0[i].int_0;
					array[i].int_3 = Form1.gstruct42_0[num].gstruct30_0[i].int_3;
					array[i].int_6 = Form1.gstruct42_0[num].gstruct30_0[i].int_6;
					array[i].int_7 = Form1.gstruct42_0[num].gstruct30_0[i].int_7;
					if (Form1.gstruct42_0[num].gstruct30_0[i].int_8 == null)
					{
						Form1.gstruct42_0[num].gstruct30_0[i].int_8 = new int[2]
						{
							1,
							1
						};
					}
					array[i].int_8 = new int[Form1.gstruct42_0[num].gstruct30_0[i].int_8.Length];
					for (int j = 0; j < array[i].int_8.Length; j++)
					{
						array[i].int_8[j] = Form1.gstruct42_0[num].gstruct30_0[i].int_8[j];
					}
					array[i].int_1 = Form1.gstruct42_0[num].gstruct30_0[i].int_1;
					array[i].int_2 = Form1.gstruct42_0[num].gstruct30_0[i].int_2;
					continue;
				}
				return;
			}
			...
			Form1.gstruct42_0[num].gstruct30_0 = new GStruct30[array.Length];
			for (int i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				Form1.gstruct42_0[num].gstruct30_0[i].string_0 = array[i].string_0;
				Form1.gstruct42_0[num].gstruct30_0[i].int_4 = array[i].int_4;
				...
				Form1.gstruct42_0[num].gstruct30_0[i].int_1 = array[i].int_1;
				Form1.gstruct42_0[num].gstruct30_0[i].int_2 = array[i].int_2;
			}
		}
		else
		{
			Form1.gstruct42_0[num].gstruct30_0 = new GStruct30[1];
			Form1.gstruct42_0[num].gstruct30_0[0].string_0 = gstruct30_.string_0;
			Form1.gstruct42_0[num].gstruct30_0[0].int_4 = gstruct30_.int_4;
			Form1.gstruct42_0[num].gstruct30_0[0].int_5 = gstruct30_.int_5;
			Form1.gstruct42_0[num].gstruct30_0[0].int_0 = gstruct30_.int_0;
			Form1.gstruct42_0[num].gstruct30_0[0].int_3 = gstruct30_.int_3;
			Form1.gstruct42_0[num].gstruct30_0[0].int_6 = gstruct30_.int_6;
			Form1.gstruct42_0[num].gstruct30_0[0].int_7 = gstruct30_.int_7;
			Form1.gstruct42_0[num].gstruct30_0[0].int_8 = new int[gstruct30_.int_8.Length];
			for (int k = 0; k < gstruct30_.int_8.Length; k++)
			{
				Form1.gstruct42_0[num].gstruct30_0[0].int_8[k] = gstruct30_.int_8[k];
			}
			Form1.gstruct42_0[num].gstruct30_0[0].int_1 = gstruct30_.int_1;
			Form1.gstruct42_0[num].gstruct30_0[0].int_2 = gstruct30_.int_2;
			listView1.Items.Clear();
			int_6 = 0;
		}
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, int_1);
		if (num < 0 || Form1.gstruct42_0 == null)
		{
			return;
		}
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			...
			Form1.gstruct42_0[i].gstruct30_0 = null;
			if (Form1.gstruct42_0[num].gstruct30_0 == null || Form1.gstruct42_0[num].gstruct30_0.Length <= 0)
			{
				continue;
			}
			Form1.gstruct42_0[i].gstruct30_0 = new GStruct30[Form1.gstruct42_0[num].gstruct30_0.Length];
			for (int j = 0; j < Form1.gstruct42_0[num].gstruct30_0.Length; j++)
			{
				Form1.gstruct42_0[i].gstruct30_0[j].string_0 = Form1.gstruct42_0[num].gstruct30_0[j].string_0;
				Form1.gstruct42_0[i].gstruct30_0[j].int_4 = Form1.gstruct42_0[num].gstruct30_0[j].int_4;
				Form1.gstruct42_0[i].gstruct30_0[j].int_5 = Form1.gstruct42_0[num].gstruct30_0[j].int_5;
				Form1.gstruct42_0[i].gstruct30_0[j].int_0 = Form1.gstruct42_0[num].gstruct30_0[j].int_0;
				Form1.gstruct42_0[i].gstruct30_0[j].int_3 = Form1.gstruct42_0[num].gstruct30_0[j].int_3;
				Form1.gstruct42_0[i].gstruct30_0[j].int_7 = Form1.gstruct42_0[num].gstruct30_0[j].int_7;
				if (Form1.gstruct42_0[num].gstruct30_0[j].int_8 == null)
				{
					Form1.gstruct42_0[num].gstruct30_0[j].int_8 = new int[2]
					{
						1,
						1
					};
				}
				Form1.gstruct42_0[i].gstruct30_0[j].int_8 = new int[Form1.gstruct42_0[num].gstruct30_0[j].int_8.Length];
				for (int k = 0; k < Form1.gstruct42_0[num].gstruct30_0[j].int_8.Length; k++)
				{
					Form1.gstruct42_0[i].gstruct30_0[j].int_8[k] = Form1.gstruct42_0[num].gstruct30_0[j].int_8[k];
				}
				Form1.gstruct42_0[i].gstruct30_0[j].int_6 = Form1.gstruct42_0[num].gstruct30_0[j].int_6;
				Form1.gstruct42_0[i].gstruct30_0[j].int_1 = Form1.gstruct42_0[num].gstruct30_0[j].int_1;
				Form1.gstruct42_0[i].gstruct30_0[j].int_2 = Form1.gstruct42_0[num].gstruct30_0[j].int_2;
				Class47.smethod_11(Form1.gstruct42_0[i]);
			}
		}
	}
	...
	private void checkBoxTrangThai_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text2)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_1 = num2;
					text = num2.ToString();
					break;
				}
			}
	...
	private void checkBoxTamDung_CheckedChanged(object sender, EventArgs e)
	{
		...
		while (true)
		{
			if (num2 < Form1.gstruct42_0[num].gstruct30_0.Length)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[num2].string_0, 1) == text)
				{
					break;
				}
				num2++;
		...
		Form1.gstruct42_0[num].gstruct30_0[num2].int_2 = Convert.ToByte(checkBoxTamDung.Checked);
	}
	...
	private void textBoxMenu_TextChanged(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].gstruct30_0 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].gstruct30_0.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].gstruct30_0[i].string_0, 1) == text)
				{
					Form1.gstruct42_0[num].gstruct30_0[i].int_8 = Form1.smethod_2(textBoxMenu.Text);
					break;
				}
			}
		}
	...
	private void textBoxSoluongMax_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_12 = Class11.smethod_12(textBoxSoluongMax.Text);
			Class55.smethod_10(Class47.string_0, "SoluongThuocMoilanMo", Form1.int_12, "", 0);
		}
	}
	...
	private void checkBoxKhongMo_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_13 = Convert.ToByte(checkBoxKhongMo.Checked);
			Class55.smethod_10(Class47.string_0, "PCDKhongMoTui", Form1.int_13, "", 0);
		}
	}
