...
internal class Class47
{
	...
	private static void smethod_10()
	{
		...
		if (num2 >= 0)
		{
			Form1.gstruct42_0[num2].bool_4 = true;
			GStruct42 gstruct42_ = Form1.gstruct42_0[num2];
			string[] array = new string[15]
			{
				"-------------------------------------------",
				"<color=yellow>" + Form1.string_1.ToUpper() + " - http://kimyen.net",
				"-------------------------------------------",
			...
			if (0 <= num2)
			{
				Form1.gstruct42_0[num2].bool_4 = false;
	...
	{
		if (gstruct43_265.uint_0 == 0 && !smethod_20(Form1.gstruct42_0[0]))
		{
			return false;
		}
		int int_ = 0;
