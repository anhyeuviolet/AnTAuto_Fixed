...
public class FormLocdo : Form
{
	...
	{
		bool flag = false;
		int num = Class71.smethod_3(Form1.gstruct42_0, int_4);
		if (0 <= num)
		{
	...
	private void FormLocdo_Load(object sender, EventArgs e)
	{
		...
		int num3 = Class71.smethod_3(Form1.gstruct42_0, int_4);
		if (0 > num3)
		{
		...
		{
			GStruct42 gStruct2 = Form1.gstruct42_0[num3];
	...
	private void checkBoxBando_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_48[0] = Convert.ToByte(checkBoxBando.Checked);
			}
		}
	}
	...
	private void comboBoxBando_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].int_48[1] = num2;
	}
	...
	private void checkBoxGiudoTheoCap_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_49[0] = Convert.ToByte(checkBoxGiudoTheoCap.Checked);
			}
		}
	}
	...
	private void checkBoxGiudoTheoHe_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_50[0] = Convert.ToByte(checkBoxGiudoTheoHe.Checked);
			}
		}
	}
	...
	private void checkBoxGiudoTheoThuoctinh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_52 = Convert.ToByte(checkBoxGiudoTheoThuoctinh.Checked);
	...
	private void comboBoxCap_SelectedIndexChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_49[1] = Class11.smethod_12(comboBoxCap.Text);
			}
		}
	}
	...
	private void comboBoxHe_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].int_50[1] = num2;
	}
	...
	private void checkBoxNhatTrongthanh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_41 = Convert.ToByte(checkBoxNhatTrongthanh.Checked);
			}
		}
	}
	...
	private void checkBoxNhatTheoThuoctinh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_42 = Convert.ToByte(checkBoxNhatTheoThuoctinh.Checked);
			}
		}
	}
	...
	private void listView1_ItemCheck(object sender, ItemCheckEventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			Form1.gstruct42_0[num].gstruct33_0[e.Index].int_0 = num2;
			if (num2 > 0)
			{
	...
	private void buttonSua_Click(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].gstruct33_0[num2].int_2 = Class11.smethod_12(textBoxMin.Text);
	...
	private void checkBoxGiudoTim_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_51 = Convert.ToByte(checkBoxGiudoTim.Checked);
			}
		}
	}
	...
	private void checkBoxKhongNhatdoTim_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_44 = Convert.ToByte(checkBoxKhongNhatdoTim.Checked);
			}
		}
	}
	...
	private void checkBoxThoahet_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_43 = Convert.ToByte(checkBoxThoahet.Checked);
			}
		}
	}
	...
	private void checkBoxGiuTrangsuc_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_45[0] = Convert.ToByte(checkBoxGiuTrangsuc.Checked);
			}
		}
	}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (text == null || Form1.gstruct42_0[num].string_3 == null)
		{
			return;
		}
		i = 0;
		while (true)
		{
			if (i < Form1.gstruct42_0[num].string_3.Length)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].string_3[i], 1) == text)
				{
					break;
				}
				i++;
		...
		Class11.smethod_25(ref Form1.gstruct42_0[num].string_3, Form1.gstruct42_0[num].string_3[i]);
		Form1.gstruct42_0[num].bool_16 = true;
	}
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_3 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].string_3.Length; i++)
			{
				if (Form1.gstruct42_0[num].string_3[i] == text)
				{
					return;
				}
			}
		...
		Class11.smethod_24(ref Form1.gstruct42_0[num].string_3, text);
		Form1.gstruct42_0[num].bool_16 = true;
	}
	...
	private void comboBoxTenVatpham_MouseDown(object sender, MouseEventArgs e)
	{
		...
		string_2 = Class69.smethod_29(Form1.gstruct42_0[num]);
		comboBoxTenVatpham.Items.Clear();
		if (string_2 != null)
		{
			for (int i = 0; i < string_2.Length; i++)
	...
	private void buttonApdungAll_Click(object sender, EventArgs e)
	{
		...
		buttonApdungAll.Enabled = false;
		int num = Class71.smethod_3(Form1.gstruct42_0, FormLocdo.int_4);
		if (num < 0)
		{
			...
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				Form1.gstruct42_0[i].int_49 = new int[2]
				{
					num6,
					num7
				};
				Form1.gstruct42_0[i].int_50 = new int[2]
				{
					num4,
					num5
				};
				Form1.gstruct42_0[i].int_51 = int_4;
				Form1.gstruct42_0[i].int_52 = int_5;
				if (Form1.gstruct42_0[i].gstruct33_0 == null)
				{
					Form1.gstruct42_0[i].gstruct33_0 = Class47.smethod_1();
				}
				try
				{
					for (int j = 0; j < Form1.gstruct42_0[i].gstruct33_0.Length; j++)
					{
						Form1.gstruct42_0[i].gstruct33_0[j].int_0 = Convert.ToByte(listView1.Items[i].Checked);
						Form1.gstruct42_0[i].gstruct33_0[j].int_2 = Class11.smethod_12(listView1.Items[i].SubItems[2].Text);
					}
				}
				catch
				{
				}
				Form1.gstruct42_0[i].int_48 = new int[2]
				{
					num2,
					num3
				};
				Form1.gstruct42_0[i].int_41 = int_2;
				Form1.gstruct42_0[i].int_42 = int_3;
				Form1.gstruct42_0[i].int_44 = int_;
				for (int k = 0; k < 2; k++)
				{
					Form1.gstruct42_0[i].int_45[k] = array[k];
					Form1.gstruct42_0[i].int_46[k] = array2[k];
					Form1.gstruct42_0[i].int_47[k] = array3[k];
				}
			}
		}
		else
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				if (num != i)
				{
					Form1.gstruct42_0[i].int_49 = new int[2]
					{
						Form1.gstruct42_0[num].int_49[0],
						Form1.gstruct42_0[num].int_49[1]
					};
					Form1.gstruct42_0[i].int_50 = new int[2]
					{
						Form1.gstruct42_0[num].int_50[0],
						Form1.gstruct42_0[num].int_50[1]
					};
					Form1.gstruct42_0[i].int_51 = Form1.gstruct42_0[num].int_51;
					Form1.gstruct42_0[i].int_52 = Form1.gstruct42_0[num].int_52;
					if (Form1.gstruct42_0[i].gstruct33_0 == null)
					{
						Form1.gstruct42_0[i].gstruct33_0 = Class47.smethod_1();
					}
					for (int j = 0; j < Form1.gstruct42_0[i].gstruct33_0.Length; j++)
					{
						Form1.gstruct42_0[i].gstruct33_0[j].int_0 = Form1.gstruct42_0[num].gstruct33_0[j].int_0;
						Form1.gstruct42_0[i].gstruct33_0[j].int_2 = Form1.gstruct42_0[num].gstruct33_0[j].int_2;
					}
					Form1.gstruct42_0[i].int_41 = Form1.gstruct42_0[num].int_41;
					Form1.gstruct42_0[i].int_42 = Form1.gstruct42_0[num].int_42;
					Form1.gstruct42_0[i].int_48 = new int[2]
					{
						Form1.gstruct42_0[num].int_48[0],
						Form1.gstruct42_0[num].int_48[1]
					};
					Form1.gstruct42_0[i].int_38 = Form1.gstruct42_0[num].int_38;
					Form1.gstruct42_0[i].int_63 = Form1.gstruct42_0[num].int_63;
					Form1.gstruct42_0[i].int_44 = Form1.gstruct42_0[num].int_44;
					for (int k = 0; k < 2; k++)
					{
						Form1.gstruct42_0[i].int_45[k] = Form1.gstruct42_0[num].int_45[k];
						Form1.gstruct42_0[i].int_46[k] = Form1.gstruct42_0[num].int_46[k];
						Form1.gstruct42_0[i].int_47[k] = Form1.gstruct42_0[num].int_47[k];
					}
				}
			}
		}
	...
	private void buttonAppdungAll2_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				...
				Form1.gstruct42_0[i].string_3 = null;
				if (Form1.gstruct42_0[num].string_3 != null)
				{
					Form1.gstruct42_0[i].string_3 = new string[Form1.gstruct42_0[num].string_3.Length];
					for (int j = 0; j < Form1.gstruct42_0[num].string_3.Length; j++)
					{
						Form1.gstruct42_0[i].string_3[j] = Form1.gstruct42_0[num].string_3[j];
					}
				}
				Form1.gstruct42_0[i].bool_16 = true;
			}
		}
		long_0 = Class11.smethod_22();
	}
	...
	private void checkBoxNgocBoi_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_47[0] = Convert.ToByte(checkBoxNgocBoi.Checked);
			}
		}
	}
	...
	private void checkBoxDaychuyen_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_46[0] = Convert.ToByte(checkBoxDaychuyen.Checked);
			}
		}
	}
	...
	private void textBoxDongNhan_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_45[1] = Class11.smethod_12(textBoxDongNhan.Text);
			}
		}
	}
	...
	private void textBoxDongNB_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_47[1] = Class11.smethod_12(textBoxDongNB.Text);
			}
		}
	}
	...
	private void textBoxDongDC_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_46[1] = Class11.smethod_12(textBoxDongDC.Text);
			}
		}
	}
