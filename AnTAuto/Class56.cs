...
internal class Class56
{
	public static void smethod_0(int int_0)
	{
		...
		while (true)
		{
			...
			if (Class11.bool_0 || num < 0 || Form1.int_20 != 3)
			{
				break;
			}
			...
			if (num14 != 0 && num13 != 0 && num15 != 0 && num18 > 1 && num13 != 10 && num13 != 21 && array3[0] != 0 && array3[1] != 0)
			{
				if (num5 == num15)
				{
					...
					flag3 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0));
					if (FormDame.int_6 <= 0)
					{
						goto IL_0835;
					}
						...
						else
						{
							...
							while (true)
							{
								if (array5[num42, 1] > 0)
								{
									...
									if (Form1.int_50 > 0 && (num21 <= 0 || num21 == array2[0]) && array2[1] > 0 && array2[2] == num15 && array2[3] > 0)
									{
										int num43 = array2[0];
										int num44 = array2[1];
										int num45 = array2[4];
