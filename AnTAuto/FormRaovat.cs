...
public class FormRaovat : Form
{
	...
	public static void smethod_0()
	{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || Form1.gstruct42_0[num].int_69[0] <= 0)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_55 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_55)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_55 = true;
					flag = true;
				}
				smethod_1(int_);
			}
	...
	private static void smethod_1(int int_2)
	{
		...
		while (true)
		{
			...
			if (num <= 0)
			{
				int num2 = Class71.smethod_3(Form1.gstruct42_0, int_2);
				if (Class11.bool_0 || num2 < 0 || Form1.gstruct42_0[num2].int_69[0] <= 0)
				{
					break;
				}
	...
	private void checkBoxRaoVat_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_69[0] = Convert.ToByte(checkBoxRaoVat.Checked);
	...
	private void comboBoxRaoVat_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].int_69[1] = num2;
		Class47.smethod_11(Form1.gstruct42_0[num]);
	}
	...
	private void textBoxTimeRaoVat_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_69[2] = Class11.smethod_12(textBoxTimeRaoVat.Text);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void textBoxTextRaoVat_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].string_8 = textBoxTextRaoVat.Text;
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
	...
	private void checkBoxRaoHinhanh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_69[3] = Convert.ToByte(checkBoxRaoHinhanh.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
				textBoxTextRaoVat.Enabled = (Form1.gstruct42_0[num].int_69[3] <= 0);
				comboBoxRaoVat.Enabled = (Form1.gstruct42_0[num].int_69[3] <= 0);
			}
		}
	}
	...
	private void checkBoxBomNoiluc_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_69[4] = Convert.ToByte(checkBoxBomNoiluc.Checked);
				Class47.smethod_11(Form1.gstruct42_0[num]);
			}
		}
	}
