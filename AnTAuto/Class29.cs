...
internal class Class29
{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_44 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_44)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_44 = true;
					flag = true;
				}
				smethod_4(int_);
			}
	...
	public static void smethod_4(int int_9)
	{
		...
		while (true)
		{
			...
			if (num <= 0)
			{
				num2 = Class71.smethod_3(Form1.gstruct42_0, int_9);
            ...
            if (Form1.gstruct42_0 == null ||
                num2 < 0 ||
                num2 >= Form1.gstruct42_0.Length ||
                Form1.gstruct42_0[num2].process_0 == null ||
                Form1.gstruct42_0[num2].process_0.HasExited)
            {
                break;
            }
            gStruct = Form1.gstruct42_0[num2];
			if (Form1.int_63 > 0 && gStruct.int_69[0] <= 0 && Class11.smethod_23(long_2) > 30000L)
			{
				string str = Form1.string_17;
				if (gStruct.bool_6)
				{
			...
			if (num9 != 0 && num11 > 1 && num10 != 0 && num10 != 10 && num10 != 21 && (gStruct.int_125[0] <= 0 || gStruct.int_125[5] <= 0))
			{
				...
				if (flag)
				{
					...
					else if (!gStruct.bool_18)
					{
						...
						if (0 <= num2)
						{
							Form1.gstruct42_0[num2].bool_18 = true;
							gStruct = Form1.gstruct42_0[num2];
						}
					}
					continue;
				...
				if (gStruct.bool_18)
				{
					...
					if (0 <= num2)
					{
						Form1.gstruct42_0[num2].bool_18 = false;
						gStruct = Form1.gstruct42_0[num2];
					}
				}
			}
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_46 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_46)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_46 = true;
					flag = true;
				}
				smethod_6(int_);
			}
	...
	public static void smethod_6(int int_9)
	{
		...
		while (!Class11.bool_0)
		{
			...
			if (num6 <= 0)
			{
				num5 = Class71.smethod_3(Form1.gstruct42_0, int_9);
				if (Class11.bool_0 || num5 < 0 || !Form1.gstruct42_0[num5].bool_36)
				{
					break;
				}
				num6 = 10;
            ...
            if (Form1.gstruct42_0 == null ||
                num5 < 0 ||
                num5 >= Form1.gstruct42_0.Length ||
                Form1.gstruct42_0[num5].process_0 == null ||
                Form1.gstruct42_0[num5].process_0.HasExited)
            {
                break;
            }
            gStruct = Form1.gstruct42_0[num5];
			...
			if (Form1.int_20 == 0 && gStruct.int_26 > 0 && gStruct.int_20 > 0 && num17 <= gStruct.int_19)
			{
			...
			if (!flag9 && !flag10 && !flag11 && Class11.smethod_23(long_2) > 800L)
			{
				...
				else
				{
					...
					if (0 <= num5)
					{
						Form1.gstruct42_0[num5].bool_18 = true;
					}
				}
				long_2 = Class11.smethod_22();
			}
		...
		while (!Class11.bool_0)
		{
			...
			if (num != Class66.gstruct42_0.int_129)
			{
				...
				else
				{
					...
					if (num2 >= 0)
					{
						gStruct2 = Form1.gstruct42_0[num2];
					}
				}
			}
			while (gStruct2.int_129 != 0 && gStruct2.gstruct39_0 != null && int_4 != null && int_4.Length != 0)
			{
				...
				for (int i = 0; i < gStruct2.gstruct39_0.Length; i++)
				{
					...
					if (Combo.int_5 == 0 || Form1.gstruct42_0 == null || Form1.gstruct42_0.Length == 0)
					{
						continue;
					}
					for (int j = 0; j < Form1.gstruct42_0.Length; j++)
					{
						if (Form1.gstruct42_0[j].bool_36 && Form1.gstruct42_0[j].int_129 != gStruct2.int_129 && (Combo.int_6 > 0 || Class32.smethod_26(Form1.gstruct42_0[j]) != 0))
						{
							int num4 = 0;
							...
							int_5 = i;
							int_6 = Combo.int_4;
							gstruct42_0 = Form1.gstruct42_0[j];
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_40 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_40)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_40 = true;
					flag = true;
				}
				smethod_20(int_);
			}
	...
	private static void smethod_20(int int_9)
	{
		...
		while (true)
		{
			...
			num = Class71.smethod_3(Form1.gstruct42_0, int_9);
			if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
			{
				break;
			}
			...
			if (num16 != 0 && num15 != 0 && num17 > 1 && num14 != 0)
			{
				...
				if (num13 > 0 && gStruct.int_123[0] > 0 && gStruct.int_129 != Class38.gstruct29_0.int_0 && Class60.smethod_3(gStruct, Class60.uint_13) == 1)
				{
					...
					if (flag && Form1.int_28 > 0 && num8 < 4 && (num14 == 336 || !smethod_0(num14)))
					{
						int num20 = 0;
						while (num20 < 8)
						{
				...
				if (gStruct.gstruct30_0 == null || (Form1.int_13 > 0 && num13 <= 0))
				{
					continue;
				}
				...
				if (gStruct2.int_4 > 0 && ((!array4[num4] && array5[num4] != num21) || Class11.smethod_23(array[num4]) >= 1000L))
				{
					...
					if (gStruct2.int_5 >= array8[0])
					{
						...
						while (flag2 = Class53.smethod_17(gStruct, gStruct2.string_0))
						{
							...
							num23 = 0;
							if (Class39.smethod_5(gStruct, Form1.int_12.ToString(), bool_0: true) <= 0)
							{
								int num27 = Class69.smethod_2(gStruct);
								if (num27 <= num21)
								{
						...
						if (array4[num4] && Form1.int_29 > 0 && Class11.smethod_23(long_) > 30000L)
						{
			...
			else if (Class11.smethod_23(array2[num4]) >= gStruct2.int_3)
			{
				...
				while (flag2 = Class53.smethod_17(gStruct, gStruct2.string_0))
				{
					...
					if (Class39.smethod_5(gStruct, Form1.int_12.ToString(), bool_0: true) <= 0)
					{
						...
						num23 = Class53.smethod_27(gStruct, gStruct2.string_0, Form1.int_12, bool_0: true);
						if (num23 <= 0)
						{
							break;
						}
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_50 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_50)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_50 = true;
					flag = true;
				}
				smethod_22(int_);
			}
	...
	private static void smethod_22(int int_9)
	{
		...
		while (true)
		{
			...
			{
				num2 = Class71.smethod_3(Form1.gstruct42_0, int_9);
				if (num2 < 0 || !Form1.gstruct42_0[num2].bool_36)
				{
					break;
                }
				num = 6;
            ...
            num4 = Form1.gstruct42_0[num2].int_75[4];
			Form1.gstruct42_0[num2].int_75[4] = 0;
			gStruct = Form1.gstruct42_0[num2];
