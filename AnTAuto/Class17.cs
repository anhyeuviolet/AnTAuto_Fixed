...
internal class Class17
{
	...
	public static void smethod_1(int int_0)
	{
		...
		{
			Thread.Sleep(200);
			num12 = Class71.smethod_3(Form1.gstruct42_0, int_0);
			if (Class11.bool_0 || num12 < 0 || Form1.int_20 != 2 || Form1.int_24 != 2)
			{
				break;
			}
			...
			if (num23 != 0 && num22 != 0 && num24 != 0 && num22 != 10 && num22 != 21 && num27 > 1)
			{
				if (!flag6)
				{
					...
					if (num3 == num25)
					{
						...
						{
							if (num31 <= 180 && num13 < Form1.int_51)
							{
								num13 = Form1.int_51;
							}
						...
						flag8 = false;
						flag9 = false;
						if (num24 != Form1.int_26)
						{
							if (Form1.int_106 > 0 && Class38.gstruct29_0.int_0 == gStruct.int_129)
							{
							...
							if (array7 != null && array7[1] == 0)
							{
								...
								if (!Form1.bool_3)
								{
									...
									int num35 = Class30.smethod_1(gStruct, Form1.int_92 <= 0);
						...
						flag11 = ((Form1.int_6 > 0 || Form1.int_7 > 0) && Form1.int_21 > 0 && (Class38.gstruct29_1.int_3 > 0 || Form1.int_22 > 0) && Class38.gstruct29_1.int_4 > 0 && Class11.smethod_57(Class38.gstruct29_1.uint_4) && (gStruct.int_129 == Class38.gstruct29_0.int_0 || Class38.gstruct29_0.int_0 <= 0));
						flag = (Form1.int_21 > 0 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_6 > 0 && Class38.gstruct29_0.int_4 == num24 && Class11.smethod_57(Class38.gstruct29_0.uint_4) && Class38.gstruct29_0.int_3 > 0);
						flag9 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0));
						array5 = new uint[2]
						{
							Class20.smethod_30(num21 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_58.uint_0, gStruct.int_130),
							Class20.smethod_30(num21 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_59.uint_0, gStruct.int_130)
						...
						if (flag && gStruct.int_129 != Class38.gstruct29_0.int_0)
						{
							...
							if (num11 <= 0L || Class11.smethod_23(num11) >= 1500L)
							{
								...
								num11 = 0L;
								if (num14 == 0 && Class53.smethod_18(array8, Class38.gstruct29_0.uint_4) > Form1.int_23 * Form1.int_23)
								{
									num8++;
									if (num8 > 3)
									{
			...
			if (num44 != 0 && gStruct.int_129 != Class66.gstruct42_0.int_129)
			{
				...
				{
					uint[] array13 = Class53.smethod_3(array11, array10, -1 * (Form1.int_23 - 50));
			...
			if (num36 > Form1.int_95 * Form1.int_95)
			{
				Class6.smethod_2(gStruct, num21, ref long_3, bool_0: true);
			}
			...
			if (flag9)
			{
				if (!Class38.smethod_6(gStruct, ref int_5) && Class73.smethod_12(gStruct) != 1)
				{
					...
					{
						array14 = ((gStruct.int_5 > 0) ? Class7.smethod_5(gStruct, num49, num30, uint_3, null, bool_2: false, Form1.int_90 > 0, bool_4: true) : Class7.smethod_6(gStruct, num49, num30, uint_3, null, bool_2: false, Form1.int_90 > 0, bool_4: true));
					...
					else if (!(flag9 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0))))
					{
						flag9 = false;
					}
					else
					{
						array14 = Class7.smethod_5(gStruct, num49, num30, uint_3, null, bool_2: false, Form1.int_90 > 0, bool_4: true);
						if (array14 != null)
						{
							if (array14[0, 0] == -100)
							{
							...
							while (true)
							{
								...
								if (Form1.int_50 > 0 && (num32 <= 0 || num32 == array3[0]) && array3[1] > 0 && array3[2] == num24 && array3[3] > 0)
								{
									int num68 = array3[0];
									int num69 = array3[1];
