...
public class FormThuocLag : Form
{
	...
	private void timer_0_Tick(object sender, EventArgs e)
	{
		...
		else if (int_1 != int_0)
		{
			...
			else
			{
				...
				method_0(Form1.gstruct42_0[num].string_5);
			}
		}
	}
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_5 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].string_5.Length; i++)
			{
				if (Form1.gstruct42_0[num].string_5[i] == text)
				{
					return;
				}
			}
		...
		Class11.smethod_24(ref Form1.gstruct42_0[num].string_5, text);
	}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_5 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].string_5.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].string_5[i], 1) == text)
				{
					Class11.smethod_25(ref Form1.gstruct42_0[num].string_5, Form1.gstruct42_0[num].string_5[i]);
					break;
				}
			}
		}
	...
	private void buttonAppAll_Click(object sender, EventArgs e)
	{
		...
		if (num >= 0 && Form1.gstruct42_0 != null)
		{
			try
			{
				...
				{
					Form1.gstruct42_0[i].int_64 = 1;
					if (i != num)
					{
						Form1.gstruct42_0[i].string_5 = null;
						if (Form1.gstruct42_0[num].string_5 != null)
						{
							Form1.gstruct42_0[i].string_5 = new string[Form1.gstruct42_0[num].string_5.Length];
							for (int j = 0; j < Form1.gstruct42_0[num].string_5.Length; j++)
							{
								Form1.gstruct42_0[i].string_5[j] = Form1.gstruct42_0[num].string_5[j];
							}
						}
