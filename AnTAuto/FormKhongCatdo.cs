...
public class FormKhongCatdo : Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager componentResourceManager = new System.ComponentModel.ComponentResourceManager(typeof(FormKhongCatdo));
		...
		comboBoxTenTuiMauHotro.Location = new System.Drawing.Point(4, 220);
		...
		listView1.Location = new System.Drawing.Point(4, 2);
		...
		columnHeader_0.Text = "Tên vật phẩm không cất vào rương";
		columnHeader_0.Width = 230;
		buttonThem.Location = new System.Drawing.Point(4, 250);
		buttonThem.Name = "buttonThem";
		buttonThem.Size = new System.Drawing.Size(60, 23);
		buttonThem.TabIndex = 219;
		buttonThem.Text = "Thêm";
		buttonThem.UseVisualStyleBackColor = true;
		buttonThem.Click += new System.EventHandler(buttonThem_Click);
		buttonXoa.Location = new System.Drawing.Point(67, 250);
		buttonXoa.Name = "buttonXoa";
		buttonXoa.Size = new System.Drawing.Size(60, 23);
		buttonXoa.TabIndex = 220;
		buttonXoa.Text = "Xóa";
		buttonXoa.UseVisualStyleBackColor = true;
		buttonXoa.Click += new System.EventHandler(buttonXoa_Click);
		buttonClose.Location = new System.Drawing.Point(162, 279);
		buttonClose.Name = "buttonClose";
		buttonClose.Size = new System.Drawing.Size(74, 26);
		...
		buttonAppAll.Location = new System.Drawing.Point(133, 250);
		buttonAppAll.Name = "buttonAppAll";
		buttonAppAll.Size = new System.Drawing.Size(123, 23);
		...
		if (bool_0)
		{
			if (int_1 != int_0)
			{
				...
				else
				{
					...
					method_0(Form1.gstruct42_0[num].string_4);
				}
			}
		}
		else
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_4 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].string_4.Length; i++)
			{
				if (Form1.gstruct42_0[num].string_4[i] == text)
				{
					return;
				}
			}
		...
		Class11.smethod_24(ref Form1.gstruct42_0[num].string_4, text);
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_4 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].string_4.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].string_4[i], 1) == text)
				{
					Class11.smethod_25(ref Form1.gstruct42_0[num].string_4, Form1.gstruct42_0[num].string_4[i]);
					Class47.smethod_11(Form1.gstruct42_0[num]);
					break;
				}
			}
		...
		if (num >= 0 && Form1.gstruct42_0 != null)
		{
			try
			{
				for (int i = 0; i < Form1.gstruct42_0.Length; i++)
				{
					if (i != num)
					{
						Form1.gstruct42_0[i].string_4 = null;
						if (Form1.gstruct42_0[num].string_4 != null)
						{
							Form1.gstruct42_0[i].string_4 = new string[Form1.gstruct42_0[num].string_4.Length];
							for (int j = 0; j < Form1.gstruct42_0[num].string_4.Length; j++)
							{
								Form1.gstruct42_0[i].string_4[j] = Form1.gstruct42_0[num].string_4[j];
							}
