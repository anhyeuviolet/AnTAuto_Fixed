...
internal class Class23
{
	...
	public static void smethod_0()
	{
		...
		int_0 = 0;
		int num3 = Class71.smethod_3(Form1.gstruct42_0, num);
		if (num3 < 0)
		{
			return;
		}
	...
	public static void smethod_7()
	{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_26)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_56 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_56)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_56 = true;
					flag = true;
				}
				smethod_8(int_);
			}
	...
	private static void smethod_8(int int_3)
	{
		...
		while (true)
		{
			...
			{
				num = 3;
				int num2 = Class71.smethod_3(Form1.gstruct42_0, int_3);
				if (num2 < 0 || !Form1.gstruct42_0[num2].bool_26)
				{
					break;
				}
