...
public class FormUutien : Form
{
	...
	private void buttonLen1_Click(object sender, EventArgs e)
	{
		...
		if (num > 0)
		{
			...
			if (num2 >= 0)
			{
				int num3 = Form1.gstruct42_0[num2].int_88[num];
				Form1.gstruct42_0[num2].int_88[num] = Form1.gstruct42_0[num2].int_88[num - 1];
				Form1.gstruct42_0[num2].int_88[num - 1] = num3;
	...
	private void buttonUuTienMacdinh_Click(object sender, EventArgs e)
	{
		...
		int int_ = Class32.smethod_28(Form1.gstruct42_0[num]);
		Form1.gstruct42_0[num].int_88 = Class47.smethod_12(int_);
