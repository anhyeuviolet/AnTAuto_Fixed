...
internal class Class6
{
	...
	public static int smethod_1(int int_1)
	{
		...
		{
			Thread.Sleep(200);
			int num20 = Class71.smethod_3(Form1.gstruct42_0, int_1);
			if (Class11.bool_0 || num20 < 0 || !Form1.gstruct42_0[num20].bool_36 || Form1.gstruct42_0[num20].int_26 <= 0)
			{
				break;
			}
			gStruct = Form1.gstruct42_0[num20];
			...
			{
				Form1.gstruct42_0[num20].bool_27 = false;
				Form1.gstruct42_0[num20].bool_18 = false;
				flag9 = false;
				gStruct = Form1.gstruct42_0[num20];
			}
			uint num26;
			...
			if (!gStruct.bool_21)
			{
				...
				if (num28 != 0 && num27 != 0 && num29 != 0 && num27 != 10 && num27 != 21 && num31 > 1)
				{
					...
					if (num2 == num30 && num == num29)
					{
						...
						flag13 = (Form1.int_21 > 0 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_4 == num29 && Class38.gstruct29_0.int_3 == num30 && Class38.gstruct29_0.int_3 > 0 && Class11.smethod_57(Class38.gstruct29_0.uint_4) && Class38.gstruct29_0.bool_2);
						if (num30 > 0)
						{
						...
						else
						{
							...
							if (!flag2)
							{
								...
								if (Class35.smethod_0(gStruct) == 0 || Class30.smethod_1(gStruct, Form1.int_92 <= 0) == 0)
								{
									continue;
								}
								flag2 = true;
						...
						if (num29 == gStruct.int_33)
						{
							...
							if (num29 == gStruct.int_33)
							{
								...
								if (gStruct.int_38 > 0 && !gStruct.bool_15 && (!flag13 || !Class51.bool_1))
								{
									...
									if (flag13 || array5 == null)
									{
										array5 = Class51.smethod_0(gStruct, array2, !flag13, Form1.int_21 > 0);
									}
									if (!flag13 && array5 != null)
									{
			...
			continue;
			IL_23ec:
			if (Class73.smethod_12(gStruct) <= 0 && Class20.smethod_30(num25 + Class47.gstruct43_43.uint_0, gStruct.int_130) != 0 && gStruct.bool_66 && gStruct.int_81 > 0 && Form1.int_93 > 0 && Class38.gstruct29_0.int_7 == Class24.gstruct38_0[Form1.int_94].int_0)
			{
			...
			if (num70 <= num38 && (!flag13 || num71 <= Form1.int_23 * Form1.int_23))
			{
				if (flag12)
				{
					int num72 = -1;
				...
				if (gStruct.bool_66 && gStruct.int_81 > 0 && Form1.int_93 == 0 && Class11.smethod_23(long_4) > gStruct.long_7)
				{
			...
			IL_13b8:
			array4 = null;
			if (!gStruct.bool_33 && gStruct.int_95 > 1 && (gStruct.int_28 > 0 || Form1.int_30 > 0))
			{
				uint uint_6 = 0u;
				uint[] uint_7 = array8;
				if (flag13)
				{
					if (Form1.int_33 > 0 && Class38.gstruct29_0.int_4 == num29 && Class38.gstruct29_0.uint_3 != 0 && Class38.gstruct29_0.uint_3 != num26)
					{
	...
	public static void smethod_3(GStruct42 gstruct42_0)
	{
		...
		while (true)
		{
			IL_0729:
			Thread.Sleep(300);
			num = Class71.smethod_3(Form1.gstruct42_0, int_);
			if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || Form1.gstruct42_0[num].int_55 == null)
			{
				break;
			}
			Form1.gstruct42_0[num].bool_11 = true;
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].bool_29 = false;
			Form1.gstruct42_0[num].bool_11 = false;
		}
		if (Class39.smethod_9(gstruct42_0))
		{
	...
	public static void smethod_4(GStruct42 gstruct42_0)
	{
		...
		if (num >= 0)
		{
			Form1.gstruct42_0[num].bool_14 = true;
			gstruct42_0 = Form1.gstruct42_0[num];
		...
		num = Class71.smethod_3(Form1.gstruct42_0, gstruct42_0.int_129);
		if (0 <= num)
		{
			Form1.gstruct42_0[num].bool_14 = false;
		}
	}
	...
	public static void smethod_5()
	{
		...
		while (true)
		{
			...
			if (Class11.bool_0 || num2 < 0 || !Form1.gstruct42_0[num2].bool_36 || Form1.gstruct42_0[num2].int_39 <= 0)
			{
				break;
			}
			Form1.gstruct42_0[num2].bool_12 = true;
		...
		if (0 <= num2)
		{
			Form1.gstruct42_0[num2].bool_12 = false;
			Class39.smethod_22(Form1.gstruct42_0[num2]);
		}
	}
}
