...
public class FormMayphu : Form
{
	...
	public static void smethod_1(int int_6)
	{
		...
		while (true)
		{
			...
			if (num <= 0)
			{
				num3 = Class71.smethod_3(Form1.gstruct42_0, int_6);
				if (num3 < 0)
				{
					break;
				}
				num = 30;
				Class58.smethod_0(gstruct42_, Form1.int_9 > 0);
			}
			gstruct42_ = Form1.gstruct42_0[num3];
			if (num4 == -1000)
			{
			...
			if (gstruct42_.int_2 > 0 && num4 > 0)
			{
				...
				string str = string_2 + num16 + string_2 + Class38.gstruct29_0.int_3 + string_2 + num14 + string_2 + num15 + string_2 + Class38.gstruct29_0.int_6 + string_2 + Class38.gstruct29_0.uint_3 + string_2 + Form1.int_108 + string_2 + Form1.int_20 + string_2 + Form1.int_100 + string_2 + Form1.int_102 + string_2 + Class16.int_0 + string_2 + Form1.int_22 + string_2 + Form1.int_30 + string_2 + Form1.int_31 + string_2 + Form1.int_32 + string_2 + Form1.int_25 + string_2 + Class38.gstruct29_0.int_2 + string_2 + Form1.int_24 + string_2 + Form1.int_83 + string_2 + Form1.int_84 + string_2 + FormDame.int_6 + string_2 + FormDame.int_5 + string_2 + FormDame.int_8 + string_2 + Class38.gstruct29_0.uint_5 + string_2 + Class38.gstruct29_0.int_7 + string_2 + Class38.gstruct29_0.uint_3 + string_2 + Form1.int_33 + string_2 + Form1.int_34 + string_2 + Form1.int_21 + string_2 + Class38.gstruct29_0.int_9 + string_2 + Class38.gstruct29_0.uint_2 + string_2 + Form1.int_85 + string_2 + Class38.gstruct29_0.int_8 + string_2 + num17 + string_2 + Form1.int_44[0] + string_2 + Form1.int_44[1] + string_2 + Form1.int_0 + string_2 + Class31.int_1 + string_2 + Form1.int_99 + string_2 + Form1.int_103 + string_2 + Form1.int_79 + string_2 + Form1.int_70 + string_2 + Form1.int_107;
				...
				if (Form1.int_8 > 0 && Class11.smethod_23(long_) >= 2500L)
				{
			...
			Form1.gstruct42_0[num3].int_2 = 0;
			break;
		}
			...
			if (text != null && !(text == string.Empty))
			{
				...
				if (num >= 43)
				{
					try
					{
						...
						Form1.int_108 = Class11.smethod_12(smethod_5(array, 7, num));
						Form1.int_20 = Class11.smethod_12(smethod_5(array, 8, num));
						Form1.int_100 = Class11.smethod_12(smethod_5(array, 9, num));
						Form1.int_102 = Class11.smethod_12(smethod_5(array, 10, num));
						Class16.int_0 = Class11.smethod_12(smethod_5(array, 11, num));
						Form1.int_22 = Class11.smethod_12(smethod_5(array, 12, num));
						Form1.int_30 = Class11.smethod_12(smethod_5(array, 13, num));
						Form1.int_31 = Class11.smethod_12(smethod_5(array, 14, num));
						Form1.int_32 = Class11.smethod_12(smethod_5(array, 15, num));
						...
						Form1.int_24 = Class11.smethod_12(smethod_5(array, 18, num));
						Form1.int_83 = 1;
						Form1.int_84 = Class11.smethod_12(smethod_5(array, 20, num));
						...
						Form1.int_33 = Class11.smethod_12(smethod_5(array, 27, num));
						Form1.int_34 = Class11.smethod_12(smethod_5(array, 28, num));
						Form1.int_21 = Class11.smethod_12(smethod_5(array, 29, num));
						...
						Form1.int_85 = Class11.smethod_12(smethod_5(array, 32, num));
						Class38.gstruct29_1.int_8 = Class11.smethod_12(smethod_5(array, 33, num));
						Class38.gstruct29_0.int_8 = Class38.gstruct29_1.int_8;
						Form1.int_44[0] = Class11.smethod_12(smethod_5(array, 35, num));
						Form1.int_44[1] = Class11.smethod_12(smethod_5(array, 36, num));
						Form1.int_0 = Class11.smethod_12(smethod_5(array, 37, num));
						Class31.int_1 = Class11.smethod_12(smethod_5(array, 38, num));
						Form1.int_99 = Class11.smethod_12(smethod_5(array, 39, num));
						Form1.int_103 = Class11.smethod_12(smethod_5(array, 40, num));
						Form1.int_79 = Class11.smethod_12(smethod_5(array, 41, num));
						Form1.int_70 = Class11.smethod_12(smethod_5(array, 42, num));
						Form1.int_107 = Class11.smethod_12(smethod_5(array, 43, num));
						goto IL_0466;
						end_IL_00a3:;
					}
					catch
	...
	private void comboBoxThemAcc_DropDown(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			...
			{
				Class86.smethod_24(Form1.gstruct42_0[i], ref string_3, 1);
			}
		}
		...
		if (Class89.smethod_0(num))
		{
			...
			if (num6 != 10 && num6 != 21 && num7 != 0 && num8 > 1)
			{
				...
				if (num == Class38.gstruct29_1.int_4)
				{
					...
					if (num9 > Form1.int_23 * Form1.int_23)
					{
						int int_7 = 0;
						...
						if (num9 > Form1.int_95 * Form1.int_95)
						{
	...
	public static int smethod_7(GStruct42 gstruct42_0, ref long long_0, ref int int_6, ref uint[] uint_0)
	{
		...
		if (num5 != 10 && num5 != 21 && num6 != 0 && num7 > 1)
		{
			...
			if (num9 > 0 && (num9 <= 0 || Class38.gstruct29_1.int_3 > 0))
			{
				...
				if (num10 <= Form1.int_23 * Form1.int_23)
				{
					Class12.smethod_3(gstruct42_0, bool_0: false);
					if (num10 > 20000L)
					{
				...
				byte[] byte_ = new byte[4];
				Class20.WriteProcessMemory(int_8, uint_, byte_, 4, ref int_7);
				if (num10 > Form1.int_95 * Form1.int_95)
				{
							...
							else
							{
								if (Class38.gstruct29_1.int_4 == 977)
								{
									...
									if (Class50.smethod_1(num9) != null)
									{
										...
										if (num22 != num9)
										{
											int num23 = Class71.smethod_3(Form1.gstruct42_0, gstruct42_0.int_129);
											if (0 <= num23)
											{
												Form1.gstruct42_0[num23].bool_29 = true;
											}
										}
									}
									return -6;
								...
								if (Form1.int_22 <= 0 && Class38.gstruct29_1.int_3 <= 0)
								{
									return 7;
								}
								...
								else
								{
									...
									if (num8 == 0 && Class38.gstruct29_1.int_3 > 0)
									{
										...
										if (gStruct.int_0 != num9 || gStruct.int_1 != Class38.gstruct29_1.int_4)
										{
											if (Form1.int_80 > 0 || !gstruct42_0.bool_63)
											{
												if (bool_4)
												{
													bool_4 = false;
													uint[] uint_2 = null;
													if (Form1.int_21 > 0 && Class38.gstruct29_1.int_0 > 0 && Class38.gstruct29_1.int_4 == num9)
													{
														uint_2 = Class38.gstruct29_1.uint_4;
													}
													if (Class44.smethod_2(gstruct42_0, "®iÓm cò", uint_2) > 0)
