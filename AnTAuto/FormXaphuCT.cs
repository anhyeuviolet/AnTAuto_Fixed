...
public class FormXaphuCT : Form
{
	...
	private void comboBoxCongThanhQuan_MouseDown(object sender, MouseEventArgs e)
	{
		...
		string_0 = null;
		Class86.smethod_24(Form1.gstruct42_0[num], ref string_0, 3);
		int_6 = Class33.smethod_0(Form1.gstruct42_0[num]);
		if (string_0 != null)
		{
	...
	private void buttonLayCongThanhQuan_Click(object sender, EventArgs e)
	{
		...
		int num2 = Class33.smethod_0(Form1.gstruct42_0[num]);
		if (string_0 != null && num2 == int_6)
		{
			...
			uint[] uint_ = null;
			int num3 = Class86.smethod_14(Form1.gstruct42_0[num], text, ref uint_);
			if (num3 <= 0)
			{
				return;
			}
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, int_0);
		if (num >= 0 && !Form1.gstruct42_0[num].bool_0)
		{
			Form1.gstruct42_0[num].bool_0 = true;
	...
	private static void smethod_0()
	{
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].bool_0 = false;
		}
	}
	...
	private static void smethod_1(int int_7)
	{
		...
		{
			Thread.Sleep(300);
			num = Class71.smethod_3(Form1.gstruct42_0, int_7);
			if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_0)
			{
				return;
			}
