...
internal class Class35
{
	...
	public static int smethod_0(GStruct42 gstruct42_0)
	{
		...
		{
			Thread.Sleep(300);
			int num6 = Class71.smethod_3(Form1.gstruct42_0, int_);
			uint num10;
			int num23;
			uint[] array5;
			uint[] array3;
			...
			{
				if (Form1.int_53[0] != 0 && Form1.int_53[1] != 0)
				{
					try
					{
						Form1.gstruct42_0[num6].bool_24 = true;
						gstruct42_0 = Form1.gstruct42_0[num6];
					}
					catch
					{
					}
								...
								if (array4 != null)
								{
									...
									if (num17 != 0)
									{
										...
										if (flag)
										{
											...
											{
												num6 = Class71.smethod_3(Form1.gstruct42_0, int_);
												if (0 <= num6)
												{
													Form1.gstruct42_0[num6].bool_22 = true;
												}
		...
		if (gstruct42_0.int_129 > 0 && (gstruct42_0.bool_22 || gstruct42_0.bool_24))
		{
			...
			if (0 <= num6)
			{
				Form1.gstruct42_0[num6].bool_22 = false;
				Form1.gstruct42_0[num6].bool_24 = false;
			}
		}
		return num;
	}
	...
	public static int smethod_1(GStruct42 gstruct42_0, int int_2 = 1)
	{
		if (!gstruct42_0.bool_24)
		{
			...
			{
				Thread.Sleep(300);
				num7 = Class71.smethod_3(Form1.gstruct42_0, int_3);
				uint num11;
				int num23;
				uint[] array5;
				uint[] array3;
				if (!Class11.bool_0 && num7 >= 0 && Form1.gstruct42_0[num7].bool_36)
				{
					try
					{
						Form1.gstruct42_0[num7].bool_24 = true;
									...
									if (num18 != 0)
									{
										...
										if (Class39.smethod_9(gstruct42_0))
										{
											...
											if (!gstruct42_0.bool_22)
											{
												...
												if (0 <= num7)
												{
													Form1.gstruct42_0[num7].bool_22 = true;
												}
											}
			...
			if (0 <= num7)
			{
				Form1.gstruct42_0[num7].bool_22 = false;
				Form1.gstruct42_0[num7].bool_24 = false;
			}
			if (flag2)
			{
				Class39.smethod_12(gstruct42_0);
	...
	public static void smethod_2()
	{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || flag2 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_57)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_54 = false;
						Form1.gstruct42_0[num].bool_57 = false;
						Class60.smethod_50(Form1.gstruct42_0[num], "* MUA VAT PHAM KET THUC !");
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_54)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_54 = true;
					Class60.smethod_50(Form1.gstruct42_0[num], "* BAT DAU MUA VAT PHAM");
					flag = true;
				}
				smethod_3(int_);
				flag2 = true;
	...
	private static void smethod_3(int int_2)
	{
		...
		{
			Thread.Sleep(300);
			int num9 = Class71.smethod_3(Form1.gstruct42_0, int_2);
			if (Class11.bool_0 || num9 < 0 || !Form1.gstruct42_0[num9].bool_36 || !Form1.gstruct42_0[num9].bool_57)
			{
				break;
			}
			gStruct = Form1.gstruct42_0[num9];
			...
			if (Form1.string_18 != null && !(Form1.string_18 == string.Empty))
			{
				if (!(a != Form1.string_18) && num3 == Form1.int_66)
				{
					goto IL_0428;
				}
				...
				num5 = 0;
				num8 = 0;
				flag2 = (Form1.int_68[0] > 0);
				num6 = Form1.int_68[1];
				num7 = Class69.smethod_31(gStruct, Form1.string_18, bool_1: true);
				string a2 = Form1.string_18.ToLower().Trim();
				if (Form1.int_66 <= 0)
				{
			...
			if (num2 >= 0)
			{
				if (Form1.int_66 > 0 && num4 == 0 && !Form1.bool_4)
				{
					if (num5 <= 0)
					{
					...
					if (gStruct.int_124 != num5)
					{
						...
						{
							Class60.smethod_50(gStruct, "MUA <color=yellow>" + Form1.string_18 + " <color>cÇn nhËp m· KTC lµ <color=yellow>" + num5 + "<color> vµo auto (phÝa trªn cña nót <color=green>Dõng<color>). L­u ý: ®iÒu nµy cã thÓ g©y diss game nªn ph¶i c©n nh¾c kü.");
							long_ = Class11.smethod_22();
						}
						empty = Form1.string_18 + " cÇn nhËp m· KTC lµ " + num5 + ". Xem H­íng dÉn ë tÇng sè kh\u00b8c cña game.";
						goto IL_0861;
					}
				}
				Class39.smethod_22(gStruct);
				...
				for (int k = 1; k < 60; k++)
				{
					...
					{
						Class39.smethod_22(gStruct);
						int num24 = Class69.smethod_31(gStruct, Form1.string_18, bool_1: true);
						int num25 = num24 - num7;
						num6 = Form1.int_68[1] - num25;
						if (num6 <= 0)
						{
							flag3 = true;
							break;
					...
					num9 = Class71.smethod_3(Form1.gstruct42_0, int_2);
					if (Class11.bool_0 || num9 < 0 || !Form1.gstruct42_0[num9].bool_36 || !Form1.gstruct42_0[num9].bool_57)
					{
						return;
					}
				...
				if (Form1.int_67 > 0 && (!flag || Class69.smethod_2(gStruct) != num21))
				{
					j = 0;
					...
					while (!Class11.bool_0 && j < 1200)
					{
						...
						if (!Form1.gstruct42_0[num9].bool_3)
						{
							break;
						}
						Thread.Sleep(10);
			...
			empty = "Kh«ng thÊy <" + Form1.string_18 + "> trong shop";
			goto IL_0861;
			IL_0861:
	...
	public static void smethod_4()
	{
		...
		while (true)
		{
			...
			{
				int num = Class71.smethod_3(Form1.gstruct42_0, int_);
				if (Class11.bool_0 || flag2 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_59)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_58 = false;
						Form1.gstruct42_0[num].bool_59 = false;
						Class60.smethod_50(Form1.gstruct42_0[num], "* SU DUNG KET THUC !");
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_58)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_58 = true;
					Class60.smethod_50(Form1.gstruct42_0[num], "* SU DUNG ITEM");
					flag = true;
				}
				smethod_5(int_);
				flag2 = true;
	...
	public static void smethod_5(int int_2)
	{
		...
		while (true)
		{
			...
			if (num3 <= 0)
			{
				num4 = Class71.smethod_3(Form1.gstruct42_0, int_2);
			...
			string b = Form1.string_18.Trim().ToLower();
			int num9 = Class69.smethod_2(gStruct);
			if (num9 <= 0)
			{
				break;
			}
			if (Form1.int_68[0] > 0 && num6 <= 0)
			{
				int num10 = Class69.smethod_31(gStruct, Form1.string_18, bool_1: true);
				if (num5 < 0)
				{
					num5 = num10;
				}
				int num11 = num5 - num10;
				if (num11 > Form1.int_68[1])
				{
					break;
				}
				num6 = Form1.int_68[1] - num11;
				if (num6 <= 0)
				{
					break;
				}
