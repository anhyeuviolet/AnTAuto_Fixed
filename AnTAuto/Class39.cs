...
internal class Class39
{
	...
	private static void smethod_21()
	{
		...
		Form1.gstruct42_0[num2].bool_2 = !Form1.gstruct42_0[num2].bool_2;
		if (Form1.gstruct42_0[num2].bool_2)
		{
			num = Form1.gstruct42_0[num2].int_129;
			...
			if ((int)Class20.smethod_30(Class47.gstruct43_120.uint_0, gstruct42_.int_130) > 0)
			{
				...
				else
				{
					...
					while (true)
					{
						...
						{
							num2 = Class71.smethod_3(Form1.gstruct42_0, gstruct42_.int_129);
							if (num2 < 0 || !Form1.gstruct42_0[num2].bool_2)
							{
		...
		if (0 <= num2)
		{
			Form1.gstruct42_0[num2].bool_2 = false;
		}
	}
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_48 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_48)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_48 = true;
					flag = true;
				}
				smethod_26(int_);
			}
	...
	private static void smethod_26(int int_4)
	{
		...
		while (true)
		{
            ...
            if (num < 0 ||                        
                ...
                num >= Form1.gstruct42_0.Length ||
                Form1.gstruct42_0[num].process_0 == null ||
                Form1.gstruct42_0[num].process_0.HasExited)
            {
                break;
            }
	...
	public static void smethod_27(int int_4, int int_5 = 0)
	{
		...
		while (!Class11.bool_0)
		{
			...
			if (num <= 0)
			{
				num2 = Class71.smethod_3(Form1.gstruct42_0, int_4);
			...
			if (!Form1.gstruct42_0[num2].bool_3 || num3 > 100)
			{
				break;
			}
		}
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_49 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_49)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_49 = true;
					flag = true;
				}
				smethod_29(int_);
			}
	...
	private static void smethod_29(int int_4)
	{
		...
		while (true)
		{
            ...
            if (num2 < 0 || num2 >= Form1.gstruct42_0.Length || Form1.gstruct42_0[num2].process_0 == null || Form1.gstruct42_0[num2].process_0.HasExited)
            {
                break;
            }
			...
			if (int_3[1] == int_4 || flag2)
			{
				...
				flag = false;
				flag2 = false;
				Form1.gstruct42_0[num2].bool_3 = false;
			}
			if (int_3[0] == int_4)
			{
				if (!flag && int_3[2] <= 0)
				...
				int_3[0] = 0;
				flag = true;
				Form1.gstruct42_0[num2].bool_3 = true;
			}
			if (!flag)
			{
				num3 = 300;
