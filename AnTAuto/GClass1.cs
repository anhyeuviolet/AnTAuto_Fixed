...
public class GClass1
{
	...
	{
        // CRACKED: Skip server check
        bool_0 = true;
        bool_1 = false;
        int_1 = 1;
        string_2 = "CRACKED";
        while (!Class11.bool_0) { Thread.Sleep(5000); }
        return;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				if (!Form1.bool_2 || Class11.uint_0 == 0)
				{
					continue;
				}
				if (bool_1)
				{
					Form1.gstruct42_0 = null;
					continue;
				}
				...
				{
					int_3 = 1;
					string object_ = Form1.string_9 + Class11.smethod_48(Class11.string_4) + Form1.string_9 + Class11.smethod_48(string.Concat(Class11.char_12));
					if (Form1.string_9.IndexOf(Form1.string_8) != 0)
					{
				...
				{
					num6 = 1;
					string object_ = Form1.string_9 + Class11.smethod_48(Class11.string_4) + Form1.string_9 + Class11.smethod_48(Class11.string_6) + gstruct13_0.long_1 + Class11.smethod_48(string.Concat(Class11.char_12));
	...
	{
		string text = Class11.smethod_1(Class11.char_15);
		if (!Class26.bool_0)
		{
			return new string[2]
			{
				text,
				Class11.smethod_1(Class11.char_16)
			};
		}
		DateTime dateTime = new DateTime(Class11.long_0);
		string text2 = Class11.smethod_1(Class11.char_17);
		if (long_1 > 0L)
		{
			text2 = ((int)new TimeSpan(Class11.long_0 - long_1).TotalDays).ToString();
		}
		string str = Class11.smethod_48(Class11.string_7);
		string str2 = null;
		for (int i = 0; i < Class26.string_0.Length; i++)
		{
			...
			str2 += Class26.string_0[i];
		}
		uint num = Class11.smethod_7(str2 + str + Class26.long_0.ToString());
		if (num != long_3 || Class11.long_0 <= 0L)
		{
			text = Class11.smethod_1(Class11.char_18);
		}
		string text3 = Class11.smethod_1(Class11.char_19) + dateTime.Day + Class11.smethod_48(Class11.string_4) + dateTime.Month + Class11.smethod_48(Class11.string_4) + dateTime.Year + ' ' + Class11.smethod_48(Class11.string_8) + text2 + Class11.smethod_1(Class11.char_20) + Class11.smethod_48(Class11.string_9);
		return new string[2]
		{
			text,
			text3
	...
	public static string smethod_4()
	{
		try
		{
			if (gstruct13_0.long_0 != 0L)
			{
				...
				return Class11.smethod_48(Class11.string_11) + Class10.smethod_1(gstruct13_0.string_1, 1) + Class11.smethod_48(Class11.string_12) + ' ' + num.ToString() + Class11.smethod_1(Class11.char_20) + Class47.string_3 + Class11.smethod_1(Class11.char_19) + d2.Day.ToString() + Class11.smethod_48(Class11.string_4) + d2.Month.ToString() + Class11.smethod_48(Class11.string_4) + d2.Year.ToString() + ' ' + d2.ToShortTimeString() + Class47.string_3 + Class11.smethod_1(Class11.char_21) + Form1.string_9;
			}
			return Class11.smethod_1(Class11.char_16);
		}
		catch
		{
		}
		...
		try
		{
			...
			if (array != null && array.Length >= 6 && array3 != null && array3.Length >= array.Length)
			{
				...
				for (int i = 0; i < array.Length; i++)
				{
					...
					str = str + array3[i] + Class11.smethod_48(Class11.string_7);
				}
