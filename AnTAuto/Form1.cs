...
public class Form1 : Form
{
    ...
    public static string string_0 = Class11.smethod_1(Class11.char_0);

    public static string string_1 = "KY" + '\u0081' + "Keoxe " + string_0;
    ...
    public static string[,] string_4 = new string[1, 6]
    {
        {
            "FB_HOIQUANVOLAM",
            "B¶o vËt",
    ...
    private static string[,] string_5 = new string[1, 6]
    {
        {
            "volamhoingo.com",
            "B¶o vËt",
    ...
    public static string string_8 = "Khong_can_nhap_gi_ca";
    ...
    public static string string_17 = Class55.smethod_6("textChatNhams", 0, "(dz)" + string_1 + " - HOIQUANVOLAM");
    ...
    private void InitializeComponent()
    {
        ...
        // notifyIcon_0
        // 
        this.notifyIcon_0.Icon = global::AnTAuto.Properties.Resources.VLTK;
        ...
        this.richTextBoxStatus.Text = "Bấm nút A để thêm nhân vật, tài khoản";
        // 
        // listView1
        // 
...
"ong game vào ô xanh lá cây của auto, còn nếu bỏ qua thì ghi số 0\n";
        ...
        this.richTextBoxBHO.Text = "Phiên bản không yêu cầu License. Nếu bạn mua cái này, hãy đòi lại tiền.";
        // 
        // label11
        // 
        ...
        this.textBoxIDSudung.ReadOnly = true;
...
" sử dụng thì bỏ check để cho nhẹ máy.";
    ...
    private void method_7()
    {
        ...
        if (GClass1.int_1 == 1)
        {
            ...
            textBoxHSD.Text = "Phiên bản không trả phí. Nếu bạn phải mua, hãy đòi lại tiền.";
            if (GClass1.int_3 == 2)
            {
                //richTextBoxBHO.Text = GClass1.smethod_4();
                richTextBoxBHO.Text = "Phiên bản không trả phí. Nếu bạn phải mua, hãy đòi lại tiền.";
            }
        }
        if (GClass1.string_1 != null && GClass1.string_1 != string.Empty && !FormTip.bool_0)
        {
            string text5 = string_0.Replace(".", "");
            ...
            {
                bool_0 = true;
                string text3 = "ĐÃ CÓ BẢN CẬP NHẬT||Phiên bản hiện tại là " + string_1 + ", hiện đã có phiên bản mới hơn là " + string_1.Replace(string_0, GClass1.string_1) + "||Bạn hãy vào tab Phụ trợ, bấm nút " + buttonCapnhat.Text + " để update lên phiên bản mới hơn này nhé !";
    ...
    private ThemXoaDanhsach formDanhSach = null;
    ...
    private void buttonAdd_Click(object sender, EventArgs e)
    {
        if (GClass1.string_2 != null && !(GClass1.string_2 == string.Empty))
        {
            ...
            if (!GClass1.bool_1)
            {
                ...
                try
                {
                    if (formDanhSach == null || formDanhSach.IsDisposed)
                    {
                        formDanhSach = new ThemXoaDanhsach();
                        formDanhSach.int_2 = base.Left;
                        formDanhSach.int_3 = base.Top;
                        formDanhSach.int_4 = base.Width;
                        formDanhSach.int_5 = base.Height;
                        formDanhSach.FormClosed += (s, a) => formDanhSach = null;
                    }

                    formDanhSach.Show();
                    formDanhSach.BringToFront();
                    formDanhSach.Focus();
                }
                catch { }
            }
            else
            {
                ...
                MessageBox.Show("PHÁT HIỆN ĐANG CHẠY PHẦN MỀM NGUY HIỂM...");
            }
        }
        else
        {
            method_2(Class11.smethod_16("S2j..."));
        }
    }
    ...
    private void buttonTrial_Click(object sender, EventArgs e)
    {
        if (!(string_8 == string_9))
        {
            ...
            Class55.smethod_10(Class47.string_0, "textIDSudung", string_9, "", 0);
            textBoxIDSudung.Text = string_9;
            richTextBoxBHO.Text = "Phiên bản không yêu cầu License. Nếu bạn mua cái này, hãy đòi lại tiền.";
        }
    }
    ...
    private void buttonBien_Click(object sender, EventArgs e)
    {
        ...
        string text = "ACCFake.MapId              : " + Class38.gstruct29_1.int_4 + "|ACCFake.CharMode           : " + Class38.gstruct29_1.int_3 + "|ACCFake.ToadoX             : " + num + "|ACCFake.ToadoY             : " + num2 + "|ACCFake.Exists             : " + Class38.gstruct29_1.int_6 + "|ACCFake.IDTarget           : " + Class38.gstruct29_1.uint_3 + "|Form1.flagDanhChienlongdong    : " + int_108 + "|Form1.IndexPK              : " + int_20 + "|Form1.IdexChientruongChinh : " + int_100 + "|Form1.IdexChientruongPhu   : " + int_102 + "|_KeoxeCLD.IndexChienlongdong   : " + Class16.int_0 + "|Form1.flagTimtrongthanh    : " + int_22 + "|Form1.flagDanhnguoi        : " + int_30 + "|Form1.flagDanhquai         : " + int_31 + "|Form1.flagUutienBoss       : " + int_32 + "|ACCFake.flagPheThuTamtru   : " + Class38.gstruct29_1.int_10 + "|ACCFake.Pk                 : " + Class38.gstruct29_1.int_2 + "|Form1.flagDanhTamtru       : " + int_24 + "|Form1.flagAccPhuChoAccChinh    : " + int_84 + "|FormDame.flagDameMacdinh   : " + FormDame.int_6 + "|FormDame.IdexKieudanh      : " + FormDame.int_5 + "|FormDame.SwicthDame        : " + FormDame.int_8 + "|ACCFake.MousePos   : " + Class38.gstruct29_1.uint_5 + "|ACCFake.KeyPress   : " + Class38.gstruct29_1.int_7 + "|ACCFake.IDTarget   : " + Class38.gstruct29_1.uint_3 + "|Form1.flagCungMuctieu  : " + int_33 + "|Form1.flagTutimMuctieu : " + int_34 + "|Form1.flagTimAccchinh  : " + int_21 + "|ACCFake.CodeFake   : " + Class38.gstruct29_1.int_9 + "|ACCFake.PLRId      : " + Class38.gstruct29_1.uint_2 + "|Form1.flagRabangTrinhsat   : " + int_85 + "|ACCFake.KeyAttack      : " + Class38.gstruct29_1.int_8 + "|Form1.BaodanhTK[0]     : " + int_44[0] + "|Form1.BaodanhTK[1]     : " + int_44[1] + "|ACCFake.CodeFake   : " + Class38.gstruct29_1.int_9;
