...
internal class Class38
{
	...
	public static void smethod_1()
	{
		...
		while (!Class11.bool_0)
		{
			...
			if (num3 <= 0)
			{
				int num10 = Class71.smethod_3(Form1.gstruct42_0, Form1.int_52);
				if (num10 < 0 || Class20.smethod_52(Form1.gstruct42_0[num10].process_0))
				{
					Form1.int_52 = 0;
					continue;
				}
				gstruct42_ = Form1.gstruct42_0[num10];
				num3 = 10;
			}
			...
			if (num15 > 0 && num16 != 0 && num17 != 0)
			{
				...
				if ((Form1.int_6 <= 0 && Form1.int_7 <= 0) || gstruct29_1.int_4 <= 0)
				{
	...
	{
		if (Form1.gstruct42_0 != null && Form1.gstruct42_0.Length != 0)
		{
			uint[] array = new uint[Form1.gstruct42_0.Length];
			for (int i = 0; i < array.Length; i++)
			{
				GStruct42 gStruct = Form1.gstruct42_0[i];
	...
	private static void smethod_3(string string_0)
	{
		if (Form1.gstruct42_0 != null)
		{
			try
			{
				...
				{
					int num = 0;
					while (Form1.gstruct42_0[i].bool_4 && num < 30)
					{
						Thread.Sleep(10);
						num++;
					}
					if (!Form1.gstruct42_0[i].bool_4)
					{
						Class60.smethod_50(Form1.gstruct42_0[i], string_0);
					}
				}
			}
			catch
	...
	public static void smethod_7(int int_2)
	{
		...
		for (int i = 0; Form1.gstruct42_0.Length > i; i++)
		{
			...
			case 4:
				Form1.int_98 = int_2;
				Form1.gstruct42_0[i].bool_61 = Form1.gstruct42_0[i].bool_36;
				continue;
			case 1:
			case 2:
				Form1.gstruct42_0[i].int_75[4] = int_2;
				continue;
			}
			if (100 <= int_2 && int_2 <= 102)
			{
				Form1.int_98 = int_2 - 100;
				Class11.smethod_32(ref Class36.int_0, Form1.gstruct42_0[i].int_129);
				if (!Class36.bool_0)
				{
					Class36.smethod_0();
				}
			...
			{
			case 103:
				Form1.gstruct42_0[i].bool_29 = Form1.gstruct42_0[i].bool_36;
				break;
			case 104:
				for (int j = 0; j < 100; j++)
				{
				...
				int_1 = Form1.gstruct42_0[i].int_129;
	...
	private static void smethod_8()
	{
		...
		if (0 <= num2)
		{
			Class53.smethod_13(Form1.gstruct42_0[num2]);
		}
	}
}
