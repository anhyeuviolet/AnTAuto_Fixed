...
internal class Class83
{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_45 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_45)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_45 = true;
					flag = true;
				}
				smethod_1(int_);
			}
	...
	private static void smethod_1(int int_1)
	{
		...
		{
			Thread.Sleep(800);
			int num2 = Class71.smethod_3(Form1.gstruct42_0, int_1);
			if (Class11.bool_0 || num2 < 0 || !Form1.gstruct42_0[num2].bool_36)
			{
				break;
			}
			num++;
			if (num < 10 || Form1.gstruct42_0[num2].int_118[0] == 0)
			{
				continue;
			}
			try
