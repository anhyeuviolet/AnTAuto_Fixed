...
internal class Class53
{
	...
	public static GStruct28[] smethod_12(GStruct42 gstruct42_0, GStruct46[] gstruct46_0, int int_1, int int_2, bool bool_0 = true)
	{
		...
		while (true)
		{
			...
			if (array.Length > num7)
			{
				...
				if (array[num7].int_4 == 4 && (Form1.int_58 <= 0 || array[num7].int_5 > 5))
				{
					if (num8 == 0)
					{
						object obj = text;
	...
	public static int smethod_14(GStruct42 gstruct42_0, string string_1, uint[] uint_0 = null, bool bool_0 = false, bool bool_1 = false, string string_2 = null)
	{
		...
		while (true)
		{
			...
			int num17 = Class71.smethod_3(Form1.gstruct42_0, gstruct42_0.int_129);
			if (Class11.bool_0 || num17 < 0 || Class20.smethod_52(Form1.gstruct42_0[num17].process_0) || !Form1.gstruct42_0[num17].bool_36)
			{
				return -1;
			}
		}
	...
	public static int smethod_22(GStruct42 gstruct42_0, uint[,] uint_0, uint[] uint_1 = null, uint[] uint_2 = null, int int_1 = -1, bool bool_0 = false, int int_2 = 0)
	{
		...
		{
			Thread.Sleep(100);
			int num12 = Class71.smethod_3(Form1.gstruct42_0, int_3);
			if (Class11.bool_0 || num12 < 0 || Class20.smethod_52(Form1.gstruct42_0[num12].process_0) || !Form1.gstruct42_0[num12].bool_36 || Class38.bool_0)
			{
				break;
			}
			gstruct42_0 = Form1.gstruct42_0[num12];
	...
	{
		int int_3 = gstruct42_0.int_129;
		int num = Class71.smethod_3(Form1.gstruct42_0, int_3);
		if (!Class11.bool_0 && num >= 0 && !Class20.smethod_52(Form1.gstruct42_0[num].process_0) && Form1.gstruct42_0[num].bool_36)
		{
