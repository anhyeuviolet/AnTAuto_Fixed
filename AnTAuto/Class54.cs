...
internal class Class54
{
	...
	public static void smethod_0(int int_1)
	{
		...
		{
			Thread.Sleep(200);
			num12 = Class71.smethod_3(Form1.gstruct42_0, int_1);
			if (Class11.bool_0 || num12 < 0 || Form1.int_20 != 1)
			{
				break;
			}
			...
			if (!gStruct.bool_21 && !gStruct.bool_6)
			{
				if (gStruct.bool_27)
				{
					Form1.gstruct42_0[num12].bool_27 = false;
					flag5 = false;
				}
				if (Form1.int_87 > 0 && !gStruct.bool_51 && int_0 <= 0)
				{
					int_0 = int_1;
					...
					if (!flag8)
					{
						if (num3 == num24)
						{
							if (num4 == num25)
							{
								...
								{
									if (num29 <= 180 && num13 < Form1.int_51)
									{
										num13 = Form1.int_51;
									}
									if (gStruct.int_123[0] > 0 && Form1.int_27 > 0 && num13 > 180)
									{
										num13 = 180;
									}
								}
								...
								if (array6 == null && 0 > num32 && (Class53.smethod_7(num24) != null || 0 > Class50.smethod_3(array4, num24)))
								{
									...
									if (num25 <= 0)
									{
										...
										if (flag4 && gStruct.bool_29)
										{
											...
											if (0 <= num12)
											{
												Form1.gstruct42_0[num12].bool_29 = flag11;
											}
											if (!flag11)
											{
												Class11.smethod_22();
								...
								{
									if (gStruct.int_129 == Class38.gstruct29_0.int_0 && Form1.int_83 <= 0 && ((Form1.int_6 <= 0 && Form1.int_7 <= 0) || Class38.gstruct29_1.int_4 <= 0))
									{
										Thread.Sleep(300);
									}
									else if (Form1.int_86 <= 0 && (!flag5 || num < 0 || num != Class69.smethod_2(gStruct)))
									{
										if (!Form1.bool_3)
										{
											num2++;
									...
									{
										if ((gStruct.int_129 == Class38.gstruct29_0.int_0 && (Form1.int_83 > 0 || ((Form1.int_6 > 0 || Form1.int_7 > 0) && Class38.gstruct29_1.int_4 > 0))) || (gStruct.int_129 != Class38.gstruct29_0.int_0 && (Form1.int_84 <= 0 || Class38.gstruct29_0.int_3 > 0)))
										{
								...
								flag14 = ((Form1.int_6 > 0 || Form1.int_7 > 0) && Form1.int_21 > 0 && (Class38.gstruct29_1.int_3 > 0 || Form1.int_22 > 0) && Class38.gstruct29_1.int_4 > 0 && Class11.smethod_57(Class38.gstruct29_1.uint_4) && (gStruct.int_129 == Class38.gstruct29_0.int_0 || Class38.gstruct29_0.int_0 <= 0));
								flag2 = (Form1.int_21 > 0 && Class38.gstruct29_0.int_0 > 0 && Class38.gstruct29_0.int_0 != gStruct.int_129 && Class38.gstruct29_0.int_6 > 0 && Class38.gstruct29_0.int_4 == num24 && Class11.smethod_57(Class38.gstruct29_0.uint_4) && Class38.gstruct29_0.int_3 > 0);
								flag10 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0));
								array4 = new uint[2]
								{
									Class20.smethod_30(num21 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_58.uint_0, gStruct.int_130),
									Class20.smethod_30(num21 + Class47.gstruct43_57.uint_0 + Class47.gstruct43_59.uint_0, gStruct.int_130)
								...
								if (flag2 && gStruct.int_129 != Class38.gstruct29_0.int_0)
								{
									...
									num6 = 0;
									int_2 = 0;
									if (num25 > 0 && !gStruct.bool_33 && gStruct.bool_64 && gStruct.int_90 == 1 && Form1.int_96 > 0 && (Form1.int_31 > 0 || Form1.int_30 > 0 || Form1.int_32 > 0) && Class20.smethod_30(num21 + Class47.gstruct43_44.uint_0, gStruct.int_130) != 0 && Class20.smethod_30(num21 + Class47.gstruct43_43.uint_0, gStruct.int_130) != 0 && Class11.smethod_23(long_3) > 600L)
									{
									...
									if (num10 <= 0L || Class11.smethod_23(num10) >= 1500L)
									{
										...
										num10 = 0L;
										if (num14 == 0 && Class53.smethod_18(uint_3, Class38.gstruct29_0.uint_4) > Form1.int_23 * Form1.int_23)
										{
											num7++;
											if (num7 > 3)
											{
										...
										if (Form1.int_27 > 0 && num25 > 0 && gStruct.int_123[0] > 0 && Class60.smethod_3(gStruct, Class60.uint_13) == 0)
										{
			...
			if (num43 > Form1.int_95 * Form1.int_95)
			{
			...
			if (flag10)
			{
				if (!Class38.smethod_6(gStruct, ref int_6) && Class73.smethod_12(gStruct) != 1)
				{
					...
					uint num55 = 0u;
					if (Form1.int_33 > 0 && (flag14 || flag2))
					{
						if (flag14)
						{
					...
					{
						array8 = ((gStruct.int_5 > 0) ? Class7.smethod_5(gStruct, num55, num28, uint_5, null, bool_2: false, Form1.int_90 > 0) : Class7.smethod_6(gStruct, num55, num28, uint_5, null, bool_2: false, Form1.int_90 > 0));
					...
					else if (!(flag10 = (!gStruct.bool_33 && (Form1.int_31 > 0 || Form1.int_30 > 0))))
					{
						flag10 = false;
					}
					else
					{
						array8 = Class7.smethod_5(gStruct, num55, num28, uint_5, null, bool_2: false, Form1.int_90 > 0);
						if (array8 != null)
						{
							if (array8[0, 0] == -100)
							{
							...
							while (true)
							{
								...
								if (Form1.int_50 > 0 && (num30 <= 0 || num30 == array2[0]) && array2[1] > 0 && array2[2] == num24 && array2[3] > 0)
								{
									int num74 = array2[0];
									int num75 = array2[1];
			...
			if (num80 != 0 && gStruct.int_129 != Class66.gstruct42_0.int_129)
			{
				...
				{
					uint[] array11 = Class53.smethod_3(uint_6, array9, -1 * (Form1.int_23 - 50));
	...
	private static void smethod_1()
	{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || (Form1.int_20 != 1 && Form1.int_20 != 3) || Form1.int_87 <= 0)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_51 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_51)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_51 = true;
					flag = true;
				}
				smethod_2(int_);
			}
	...
	private static void smethod_2(int int_1)
	{
		...
		while (true)
		{
			num2--;
			Thread.Sleep(300);
			if (Class11.bool_0 || (Form1.int_20 != 1 && Form1.int_20 != 3) || Form1.int_87 <= 0)
			{
				break;
			}
			if (num2 <= 0)
			{
				num = Class71.smethod_3(Form1.gstruct42_0, int_1);
				if (num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					break;
				}
				num2 = 3;
