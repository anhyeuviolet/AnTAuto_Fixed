...
public class FormSuado : Form
{
	...
	private void FormSuado_Load(object sender, EventArgs e)
	{
		...
		textBoxValueDobenThap.Text = Form1.int_76.ToString();
		checkBoxThodiaphuDobenThap.Checked = (Form1.int_77 > 0);
		checkBoxOutGameKhidobenThap.Checked = (Form1.int_75 > 0);
		checkBoxKhongSuaTK.Checked = (Form1.int_56 > 0);
		checkBoxOutGameKhidobenThap.Enabled = (Form1.int_77 > 0);
		checkBoxLuonSuaKhiMuathuoc.Checked = (Form1.int_57 > 0);
		checkBoxBachKim.Checked = (Form1.int_58 > 0);
		textBoxPhanTram.Text = Form1.int_60[0].ToString();
		textBoxDiem.Text = Form1.int_60[1].ToString();
		checkBoxPhiChiendau.Checked = (Form1.int_59 > 0);
		textBox1.Text = Form1.int_78.ToString();
	...
	private void checkBoxThodiaphuDobenThap_CheckedChanged(object sender, EventArgs e)
	{
		...
		{
			Form1.int_77 = Convert.ToByte(checkBoxThodiaphuDobenThap.Checked);
			Class55.smethod_10(Class47.string_0, "flagThodiaphuDobenThap", Form1.int_77, "", 0);
			checkBoxOutGameKhidobenThap.Enabled = (Form1.int_77 > 0);
		}
	}
	...
	private void textBoxValueDobenThap_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_76 = Class11.smethod_12(textBoxValueDobenThap.Text);
			if (Form1.int_76 < 3)
			{
				Form1.int_76 = 3;
			}
			Class55.smethod_10(Class47.string_0, "nDobenThap", Form1.int_76, "", 0);
		}
	}
	...
	private void checkBoxOutGameKhidobenThap_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_75 = Convert.ToByte(checkBoxOutGameKhidobenThap.Checked);
			Class55.smethod_10(Class47.string_0, "nDobenOut", Form1.int_75, "", 0);
		}
	}
	...
	private void checkBoxKhongSuaTK_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_56 = Convert.ToByte(checkBoxKhongSuaTK.Checked);
			Class55.smethod_10(Class47.string_0, "flagKhongSuaTK", Form1.int_56, "", 0);
		}
	}
	...
	private void checkBoxLuonSuaKhiMuathuoc_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_57 = Convert.ToByte(checkBoxLuonSuaKhiMuathuoc.Checked);
			Class55.smethod_10(Class47.string_0, "flagLuonSuaMua", Form1.int_57, "", 0);
		}
	}
	...
	private void checkBoxBachKim_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_58 = Convert.ToByte(checkBoxBachKim.Checked);
			Class55.smethod_10(Class47.string_0, "flagSudoBachKim", Form1.int_58, "", 0);
		}
	}
	...
	private void textBoxPhanTram_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_60[0] = Class11.smethod_12(textBoxPhanTram.Text);
			if (Form1.int_60[0] <= 10)
			{
				Form1.int_60[0] = 10;
			}
			Class55.smethod_10(Class47.string_0, "fSuado1_0", Form1.int_60[0], "", 0);
		}
	}
	...
	private void textBoxDiem_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_60[1] = Class11.smethod_12(textBoxDiem.Text);
			if (Form1.int_60[1] < 5)
			{
				Form1.int_60[1] = 5;
			}
			Class55.smethod_10(Class47.string_0, "fSuado1_1", Form1.int_60[1], "", 0);
		}
	}
	...
	private void checkBoxPhiChiendau_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_0)
		{
			Form1.int_59 = Convert.ToByte(checkBoxPhiChiendau.Checked);
			Class55.smethod_10(Class47.string_0, "fSuaPhichiendau", Form1.int_59, "", 0);
		}
	}

	private void textBox1_TextChanged(object sender, EventArgs e)
	{
		Form1.int_78 = Class11.smethod_12(textBox1.Text);
		if (Form1.int_78 < 10)
		{
			Form1.int_78 = 10;
		}
		else if (Form1.int_78 > 180)
		{
			Form1.int_78 = 180;
		}
		Class55.smethod_10(Class47.string_0, "ThoigianSua", Form1.int_78, "", 0);
	}
}
