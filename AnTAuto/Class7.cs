...
internal class Class7
{
	...
	public static int[,] smethod_5(GStruct42 gstruct42_0, uint uint_2, int int_4 = 600, uint[] uint_3 = null, int[] int_5 = null, bool bool_2 = false, bool bool_3 = false, bool bool_4 = false)
	{
		...
		while (true)
		{
			...
			bool flag4 = false;
			if (flag2 && Form1.int_109 > 0 && num22 <= 0)
			{
			...
			while (!flag4 && (uint_2 == 0 || num33 != uint_2))
			{
				...
				if (num22 <= 0)
				{
					if (Form1.int_31 <= 0 || (num11 > 0 && num34 == num11 && num34 != 4))
					{
						goto IL_0e4f;
					}
					if (flag)
					{
						...
						if (Form1.int_32 > 0 && Form1.int_36 > 0)
						{
							flag4 = true;
							continue;
						}
				...
				{
					if (Form1.int_30 <= 0 || num23 <= 0 || num34 == 0 || num11 == 0 || num8 == 0 || (Form1.int_35 <= 0 && (num32 == 3 || num32 == 4)))
					{
						goto IL_0e4f;
					}
					if (Form1.int_81 > 0)
	...
	public static int[,] smethod_6(GStruct42 gstruct42_0, uint uint_2, int int_4 = 600, uint[] uint_3 = null, int[] int_5 = null, bool bool_2 = false, bool bool_3 = false, bool bool_4 = false)
	{
		...
		if (num18 > 1)
		{
			...
			for (num21 = 1u; num21 < 256; num21++)
			{
				...
				int num34 = 0;
				bool flag4 = false;
				if (flag2 && Form1.int_109 > 0 && num24 <= 0)
				{
				...
				while (true)
				{
					...
					if (!flag4 && (uint_2 == 0 || num28 != uint_2))
					{
						...
						if (num24 <= 0)
						{
							if (Form1.int_31 <= 0 || (num10 > 0 && num29 == num10 && num29 != 4))
							{
								break;
							}
							if (flag)
						...
						{
							if (Form1.int_30 <= 0 || num25 <= 0 || num29 == 0 || num10 == 0 || num12 == 0 || (Form1.int_35 <= 0 && (num27 == 3 || num27 == 4)))
							{
								break;
							}
							if (Form1.int_81 > 0)
