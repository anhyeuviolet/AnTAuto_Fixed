...
public class FormClickNPC : Form
{
	...
	private void FormClickNPC_Load(object sender, EventArgs e)
	{
		...
		base.TopMost = true;
		int num3 = Class71.smethod_3(Form1.gstruct42_0, int_0);
		if (num3 < 0)
		{
		...
		{
			GStruct42 gStruct = Form1.gstruct42_0[num3];
		...
		checkBoxChinhXacTen.Checked = (Form1.int_5 > 0);
		bool_1 = true;
	...
	private void checkBoxGiaoVatpham1_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_15 = Convert.ToByte(checkBoxGiaoVatpham1.Checked);
			}
		}
	}
	...
	private void checkBoxGiaoVatpham2_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_16 = Convert.ToByte(checkBoxGiaoVatpham2.Checked);
			}
		}
	}
	...
	private void checkBoxGiaoVatpham3_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_17 = Convert.ToByte(checkBoxGiaoVatpham3.Checked);
			}
		}
	}
	...
	private void comboBoxItemGiao1_MouseDown(object sender, MouseEventArgs e)
	{
		...
		bool_1 = false;
		string_1 = Class69.smethod_29(Form1.gstruct42_0[num]);
		comboBoxItemGiao1.Items.Clear();
		if (string_1 != null)
		{
	...
	private void comboBoxItemGiao3_MouseDown(object sender, MouseEventArgs e)
	{
		...
		bool_1 = false;
		string_3 = Class69.smethod_29(Form1.gstruct42_0[num]);
		comboBoxItemGiao3.Items.Clear();
		if (string_3 != null)
		{
	...
	private void checkBoxCosudungVatpham_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_12 = Convert.ToByte(checkBoxCosudungVatpham.Checked);
			}
		}
	}
	...
	private void textBoxMenuVatpham_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_13 = smethod_0(textBoxMenuVatpham.Text);
			}
		}
	}
	...
	private void comboBoxVatpham_MouseDown(object sender, MouseEventArgs e)
	{
		...
		bool_1 = false;
		string_0 = Class69.smethod_29(Form1.gstruct42_0[num]);
	...
	private void comboBoxVatpham_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].string_1 = string_0[num2];
	}
	...
	private void checkBoxDoithoaiTruoc_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_14 = Convert.ToByte(checkBoxDoithoaiTruoc.Checked);
			}
		}
	}
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, int_0);
		if (num < 0 || Form1.gstruct42_0 == null || num < 0)
		{
			return;
		}
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			...
			Form1.gstruct42_0[i].int_12 = Form1.gstruct42_0[num].int_12;
			Form1.gstruct42_0[i].string_1 = Form1.gstruct42_0[num].string_1;
			Form1.gstruct42_0[i].int_13 = null;
			if (Form1.gstruct42_0[num].int_13 != null)
			{
				Form1.gstruct42_0[i].int_13 = new int[Form1.gstruct42_0[num].int_13.Length];
				for (int j = 0; j < Form1.gstruct42_0[num].int_13.Length; j++)
				{
					Form1.gstruct42_0[i].int_13[j] = Form1.gstruct42_0[num].int_13[j];
				}
			}
			Form1.gstruct42_0[i].int_14 = Form1.gstruct42_0[num].int_14;
			Form1.gstruct42_0[i].int_15 = Form1.gstruct42_0[num].int_15;
			Form1.gstruct42_0[i].int_16 = Form1.gstruct42_0[num].int_16;
			Form1.gstruct42_0[i].int_17 = Form1.gstruct42_0[num].int_17;
			Form1.gstruct42_0[i].int_18 = Form1.gstruct42_0[num].int_18;
		}
	}
	...
	public static void smethod_1()
	{
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			if (!Form1.gstruct42_0[i].bool_36)
			{
				continue;
			}
			for (int j = 0; j < 100; j++)
			...
			int_11 = Form1.gstruct42_0[i].int_129;
	...
	public static void smethod_2()
	{
		...
		GStruct42 gstruct42_ = Form1.gstruct42_0[num2];
		int int_ = 0;
	...
	public static void smethod_4(int int_13)
	{
		...
		do
		{
			...
			if (num2 <= 0)
			{
				num = Class71.smethod_3(Form1.gstruct42_0, int_13);
				num2 = 15;
			}
			if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_6)
			{
				break;
			}
			if (Form1.gstruct42_0[num].int_9 == null)
			{
				Form1.gstruct42_0[num].int_9 = new int[3]
				{
					2,
					1,
					1
			...
			if (Form1.gstruct42_0[num].int_7 == null)
			{
				Form1.gstruct42_0[num].int_7 = new int[2]
				{
					0,
					3
				};
			}
			if (Form1.gstruct42_0[num].int_10 < 0 || Form1.gstruct42_0[num].int_10 > 15000)
			{
				Form1.gstruct42_0[num].int_10 = 300;
			}
            ...
            if (num15 != 0 && num16 > 1)
            {
                ...
                if (Class39.smethod_9(gstruct42_))
                {
                    ...
                    if (flag5)
                    {
                        Class39.smethod_19(gstruct42_, uint_3, uint_4, string_5, int_6, Form1.int_5 > 0);
                    }
                    if (flag6)
                    {
                        Class39.smethod_19(gstruct42_, uint_3, uint_4, string_6, int_7, Form1.int_5 > 0);
                    }
                    if (flag7)
                    {
                        Class39.smethod_19(gstruct42_, uint_3, uint_4, string_7, int_8, Form1.int_5 > 0);
                    }
                    Thread.Sleep(400);
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].bool_6 = false;
			Form1.gstruct42_0[num].bool_27 = true;
		}
	...
	public static void smethod_5(GStruct42 gstruct42_0, string string_9, int int_13)
	{
		...
		while (true)
		{
			num4 = Class71.smethod_3(Form1.gstruct42_0, gstruct42_0.int_129);
			...
			if (!flag)
			{
				Form1.gstruct42_0[num4].bool_13 = true;
				flag = true;
			}
		...
		if (0 <= num4)
		{
			Form1.gstruct42_0[num4].bool_13 = false;
		}
	}
	...
	private void checkBoxCoMuaVatpham_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num >= 0)
			{
				Form1.gstruct42_0[num].int_18 = Convert.ToByte(checkBoxCoMuaVatpham.Checked);
			}
		}
	}
	...
	private void comboBoxMuaVP_MouseDown(object sender, MouseEventArgs e)
	{
		...
		bool_1 = false;
		string_4 = Class69.smethod_29(Form1.gstruct42_0[num]);
		comboBoxMuaVP.Items.Clear();
		if (string_4 != null)
		{
	...
	private void linkLabelMuaPhaohoa_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 250, 80);
	}
	...
	private void checkBoxChinhXacTen_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_5 = Convert.ToByte(checkBoxChinhXacTen.Checked);
			Class55.smethod_10(Class47.string_0, "flagChinhxacTenVatpham", Form1.int_5, "", 0);
		}
	}
}
