...
public class FormLocdoTest : Form
{
	...
	private void buttonSua_Click(object sender, EventArgs e)
	{
		...
		Form1.gstruct42_0[num].gstruct33_0[num2].int_3 = Class11.smethod_12(textBoxDong.Text);
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, int_0);
		if (Form1.gstruct42_0 == null || num < 0)
		{
			return;
		}
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			if (num != i)
			{
				...
				for (int j = 0; j < Form1.gstruct42_0[i].gstruct33_0.Length; j++)
				{
					...
					Form1.gstruct42_0[i].gstruct33_0[j].int_3 = Form1.gstruct42_0[num].gstruct33_0[j].int_3;
	...
	{
		if (!timer_0.Enabled || Form1.gstruct42_0 == null)
		{
			return;
		}
		string_1 = null;
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			Class69.smethod_30(Form1.gstruct42_0[i], ref string_1);
		}
		if (string_1 == null)
		{
			return;
	...
	{
		if (!timer_0.Enabled || bool_3 || Form1.gstruct42_0 == null || string_1 == null)
		{
			return;
		}
	...
	public static void smethod_3(int int_17)
	{
		...
		while (true)
		{
			...
			if (num2 <= 0)
			{
				num = Class71.smethod_3(Form1.gstruct42_0, int_17);
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36 || !Form1.gstruct42_0[num].bool_5 || string_0 == null || string_0 == string.Empty)
				{
					break;
				}
		...
		if (0 <= num)
		{
			Form1.gstruct42_0[num].bool_5 = false;
