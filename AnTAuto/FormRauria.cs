...
public class FormRauria : Form
{
	...
	private void FormRauria_Load(object sender, EventArgs e)
	{
		...
		bool flag = false;
		if (!FormMayphu.bool_1 && Form1.gstruct42_0 == null)
		{
			int num3 = -1;
		...
		checkBoxBaoCuusat.Checked = (Form1.int_14 > 0);
		checkBoxBaoCuusatPhucan.Checked = (Form1.int_16 > 0);
		checkBoxBaoCsKenhbang.Checked = (Form1.int_15 > 0);
		checkBoxChayNhay.Checked = (Form1.int_35 > 0);
		textBoxKhoangCachlenNgua.Text = Form1.int_95.ToString();
		checkBoxKhongDanhAccCungbang.Checked = (Form1.int_97 > 0);
		checkBoxSuado.Checked = (Form1.int_55 > 0);
		checkBoxDoiPKTheoAccChinh.Checked = (Form1.int_79 > 0);
		checkBoxTroLaiDiemcu.Checked = (Form1.int_80 > 0);
		checkBoxKhongdanhCapnho.Checked = (Form1.int_81 > 0);
		numericUpDownKhongdanhCapnho.Value = Form1.int_82;
		checkBoxKhongChaybo.Checked = (Form1.int_19 > 0);
		checkBoxAcChinhNghelenh.Checked = (Form1.int_7 > 0);
		checkBoxTHP_Smdb.Checked = (Form1.int_11 > 0);
		checkBoxXuongngua.Checked = (Form1.int_96 > 0);
		checkBoxRoom.Checked = (Form1.int_8 > 0);
		checkBoxKhoaChatmat.Checked = (Form1.int_9 > 0);
		checkBoxPassword.Checked = (Form1.int_48 > 0);
		numericUpDownPassword.Value = Form1.int_49;
		checkBoxDanhDenchet.Checked = (Form1.int_50 > 0);
		...
		checkBoxThongbaoTHP.Checked = (Form1.int_111 > 0);
		...
		textBoxTiepCan.Text = Form1.int_51.ToString();
	...
	private void timer_0_Tick(object sender, EventArgs e)
	{
		...
		if (bool_0)
		{
			...
			if (int_6 > 0)
			{
				int num = Class71.smethod_3(Form1.gstruct42_0, int_6);
				if (0 <= num)
				{
					Class47.smethod_11(Form1.gstruct42_0[num]);
				}
			...
			int_6 = int_0;
			int num2 = Class71.smethod_3(Form1.gstruct42_0, int_0);
			flag = (0 <= num2);
			string text2 = "[chưa chọn ac]";
			if (flag)
			{
				gstruct42_0 = Form1.gstruct42_0[num2];
	...
	private void checkBoxChayNhay_CheckedChanged(object sender, EventArgs e)
	{
		...
		{
			Form1.int_35 = Convert.ToByte(checkBoxChayNhay.Checked);
			Class55.smethod_10(Class47.string_0, "flagDanhNguoiChayNhay", Form1.int_35, "", 0);
		}
	}
	...
	private void checkBoxKhongdanhCapnho_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_81 = Convert.ToByte(checkBoxKhongdanhCapnho.Checked);
			Class55.smethod_10(Class47.string_0, "flagKhongDanhCapnho", Form1.int_81, "", 0);
		}
	}
	...
	private void numericUpDownKhongdanhCapnho_ValueChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_82 = (int)numericUpDownKhongdanhCapnho.Value;
			Class55.smethod_10(Class47.string_0, "ValueCapBoqua", Form1.int_82, "", 0);
		}
	}
	...
	private void textBoxKhoangCachlenNgua_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_95 = Class11.smethod_12(textBoxKhoangCachlenNgua.Text);
			Class55.smethod_10(Class47.string_0, "KhoangCachLenNguaEx", Form1.int_95, "", 0);
		}
	}
	...
	private void checkBoxDoiPKTheoAccChinh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_79 = Convert.ToByte(checkBoxDoiPKTheoAccChinh.Checked);
			Class55.smethod_10(Class47.string_0, "flagDoiPKTheoAccChinh", Form1.int_79, "", 0);
		}
	}
	...
	private void checkBoxKhongDanhAccCungbang_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_97 = Convert.ToByte(checkBoxKhongDanhAccCungbang.Checked);
			Class55.smethod_10(Class47.string_0, "KhongdanhCungBang", Form1.int_97, "", 0);
		}
	}
	...
	private void checkBoxBaoCuusat_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_14 = Convert.ToByte(checkBoxBaoCuusat.Checked);
			Class55.smethod_10(Class47.string_0, "flagBaoCuusatMat", Form1.int_14, "", 0);
		}
	}
	...
	private void checkBoxSuado_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_55 = Convert.ToByte(checkBoxSuado.Checked);
			Class55.smethod_10(Class47.string_0, "flagSuadoTaichoEx", Form1.int_55, "", 0);
		}
	}
	...
	private void checkBoxTroLaiDiemcu_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_80 = Convert.ToByte(checkBoxTroLaiDiemcu.Checked);
			Class55.smethod_10(Class47.string_0, "flagTrolaiDiemcu", Form1.int_80, "", 0);
		}
	}
	...
	private void checkBoxKhongChaybo_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_19 = Convert.ToByte(checkBoxKhongChaybo.Checked);
			Class55.smethod_10(Class47.string_0, "flagKhongChaybo", Form1.int_19, "", 0);
		}
	}
	...
	private void labelBoqua_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 280, 280);
	}
	...
	private void checkBoxAcChinhNghelenh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_7 = Convert.ToByte(checkBoxAcChinhNghelenh.Checked);
			Class55.smethod_10(Class47.string_0, "flagKeo2", Form1.int_7, "", 0);
		}
	}
	...
	private void checkBoxAcChihuy_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			Form1.gstruct42_0[num].int_2 = num2;
			if (num2 > 0)
			{
				Form1.int_7 = 0;
				checkBoxAcChinhNghelenh.Checked = false;
				FormMayphu.int_0 = Form1.gstruct42_0[num].int_129;
	...
	private void buttonHelp_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 440, 300);
	...
	private void checkBoxTHP_Smdb_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_11 = Convert.ToByte(checkBoxTHP_Smdb.Checked);
			Class55.smethod_10(Class47.string_0, "flagLienthongMapAB", Form1.int_11, "", 0);
		}
	}
	...
	private void labelLienthongGiaithich_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 380, 320);
	}
	...
	private void checkBoxBaoCuusatPhucan_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_16 = Convert.ToByte(checkBoxBaoCuusatPhucan.Checked);
			Class55.smethod_10(Class47.string_0, "flagBaoCuusatPhucan", Form1.int_16, "", 0);
		}
	}
	...
	private void buttonCacChucNangDkTuxa_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 420, 230);
	}
	...
	private void checkBoxXuongngua_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_96 = Convert.ToByte(checkBoxXuongngua.Checked);
			Class55.smethod_10(Class47.string_0, "flagXuongNguaSansang", Form1.int_96, "", 0);
		}
	}
	...
	private void checkBoxRoom_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_8 = Convert.ToByte(checkBoxRoom.Checked);
			Class55.smethod_10(Class47.string_0, "flagBaoroom", Form1.int_8, "", 0);
		}
	}
	...
	private void checkBoxKhoaChatmat_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_9 = Convert.ToByte(checkBoxKhoaChatmat.Checked);
			Class55.smethod_10(Class47.string_0, "flagKhoaChatmat", Form1.int_9, "", 0);
		}
	}
	...
	private void checkBoxPassword_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_48 = Convert.ToByte(checkBoxPassword.Checked);
			Class55.smethod_10(Class47.string_0, "flagPassKeoNhieumay", Form1.int_48, "", 0);
		}
	}
	...
	private void numericUpDownPassword_ValueChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_49 = (int)numericUpDownPassword.Value;
			Class55.smethod_10(Class47.string_0, "PassKeoNhieumay", Form1.int_49, "", 0);
		}
	}
	...
	private void comboBoxLuonDanh_MouseDown(object sender, MouseEventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			...
			{
				Class86.smethod_23(Form1.gstruct42_0[i], ref string_4);
			}
		}
	...
	private void comboBoxKhongDanh_MouseDown(object sender, MouseEventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				Class86.smethod_23(Form1.gstruct42_0[i], ref string_5);
			}
		}
	...
	private void comboBoxKhongdanhAc_MouseDown(object sender, MouseEventArgs e)
	{
		...
		if (Form1.gstruct42_0 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0.Length; i++)
			{
				Class86.smethod_24(Form1.gstruct42_0[i], ref string_6, 1);
			}
		}
	...
	private void labelThemPTAcKhongdanh_Click(object sender, EventArgs e)
	{
		...
		for (int i = 0; i < Form1.gstruct42_0.Length; i++)
		{
			GStruct48 gStruct = Class72.smethod_5(Form1.gstruct42_0[i]);
			if (gStruct.int_0 <= 0)
			{
				continue;
			}
	...
	private void checkBoxDanhDenchet_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_50 = Convert.ToByte(checkBoxDanhDenchet.Checked);
			Class55.smethod_10(Class47.string_0, "flagDanhDenchet", Form1.int_50, "", 0);
		}
	}
	...
	private void textBoxTiepCan_TextChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_51 = Class11.smethod_12(textBoxTiepCan.Text);
			Class55.smethod_10(Class47.string_0, "KCAcdanhTiepcan", Form1.int_51, "", 0);
		}
	}
	...
	private void labelTiepcan_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 380, 140);
	}
	...
	private void buttonRandom_Click(object sender, EventArgs e)
	{
		...
		Class55.smethod_10(Class47.string_0, "PortServer", Class62.int_2, "", 0);
		bool_1 = true;
		MessageBox.Show("Lưu ý ở máy phụ phải ghi đúng passowrd là " + Class62.int_2 + " thì mới kết nối được.", Form1.string_1, MessageBoxButtons.OK);
	}
	...
	private void buttonBatdau_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (Class62.int_2 < int_9 || Class62.int_2 > int_10)
			{
				...
				Class55.smethod_10(Class47.string_0, "PortServer", Class62.int_2, "", 0);
				textBoxPassServer.Text = Class62.int_2.ToString();
				MessageBox.Show("Password phải là số từ " + int_9 + " -> " + int_10 + ", auto tự động lấy lại password khác là " + Class62.int_2, Form1.string_1, MessageBoxButtons.OK);
			}
			Class62.int_0 = 1;
	...
	private void textBoxPassServer_Leave(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			...
			if (num < int_9 || num > int_10)
			{
				...
				MessageBox.Show("Password phải là số từ " + int_9 + " -> " + int_10 + ", auto tự động lấy lại password khác là " + num, Form1.string_1, MessageBoxButtons.OK);
			}
			Class62.int_2 = num;
			Class55.smethod_10(Class47.string_0, "PortServer", Class62.int_2, "", 0);
		}
	...
	private void buttonHuongdan_Click(object sender, EventArgs e)
	{
		...
		FormTip.smethod_0(Form1.string_1, text, 600000, 440, 100);
		string string_ = Environment.GetEnvironmentVariable("programfiles") + "\\Google\\Chrome\\Application\\chrome.exe";
		if (!Class11.smethod_18(string_))
		{
			string_ = Class55.smethod_0();
	...
	private void checkBoxThongbaoTHP_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_111 = Convert.ToByte(checkBoxThongbaoTHP.Checked);
			Class55.smethod_10(Class47.string_0, "fThongbaoTHP", Form1.int_111, "", 0);
		}
	}
	...
	private void checkBoxBaoCsKenhbang_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled && bool_1)
		{
			Form1.int_15 = Convert.ToByte(checkBoxBaoCsKenhbang.Checked);
			Class55.smethod_10(Class47.string_0, "flagBaoCuusatBang", Form1.int_15, "", 0);
		}
	}
