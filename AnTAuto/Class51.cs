...
internal class Class51
{
		...
		while (true)
		{
			try
			{
				...
				if (Class11.bool_0 || num < 0 || !Form1.gstruct42_0[num].bool_36)
				{
					if (0 <= num)
					{
						Form1.gstruct42_0[num].bool_43 = false;
					}
					return;
				}
				if (!flag)
				{
					if (Form1.gstruct42_0[num].bool_43)
					{
						return;
					}
					Form1.gstruct42_0[num].bool_43 = true;
					flag = true;
				}
				smethod_2(int_);
			}
	...
	private static void smethod_2(int int_2)
	{
		...
		{
			Thread.Sleep(600);
			int num4 = Class71.smethod_3(Form1.gstruct42_0, int_2);
			if (Class11.bool_0 || num4 < 0 || !Form1.gstruct42_0[num4].bool_36)
			{
				break;
			}
			Form1.gstruct42_0[num4].bool_15 = false;
			...
			if (Class11.smethod_23(long_) > 3000L)
			{
				...
				if (num5 > 0)
				{
					...
					{
						Form1.gstruct42_0[num4].gstruct34_0 = new GStruct34[gStruct.gstruct34_0.Length];
						for (int i = 0; i < gStruct.gstruct34_0.Length; i++)
						{
							Form1.gstruct42_0[num4].gstruct34_0[i].int_0 = gStruct.gstruct34_0[i].int_0;
							Form1.gstruct42_0[num4].gstruct34_0[i].long_0 = gStruct.gstruct34_0[i].long_0;
							Form1.gstruct42_0[num4].gstruct34_0[i].uint_0 = gStruct.gstruct34_0[i].uint_0;
						}
					}
					else
					{
						Form1.gstruct42_0[num4].gstruct34_0 = null;
					}
				}
				if (!bool_0)
				{
	...
	public static bool smethod_3(GStruct42 gstruct42_0)
	{
		...
		for (uint num6 = 1u; num6 < Class47.int_1 && (0 >= num4 || num4 > num5); num6++)
		{
			...
			if (!flag)
			{
				...
				if (0 <= num)
				{
					Form1.gstruct42_0[num].bool_15 = true;
				}
				flag = true;
				bool_1 = true;
				Thread.Sleep(300);
		...
		if (num >= 0)
		{
			...
			{
				Form1.gstruct42_0[num].gstruct34_0 = new GStruct34[gstruct42_0.gstruct34_0.Length];
				for (int k = 0; k < gstruct42_0.gstruct34_0.Length; k++)
				{
					Form1.gstruct42_0[num].gstruct34_0[k].uint_0 = gstruct42_0.gstruct34_0[k].uint_0;
					Form1.gstruct42_0[num].gstruct34_0[k].long_0 = gstruct42_0.gstruct34_0[k].long_0;
					Form1.gstruct42_0[num].gstruct34_0[k].int_0 = gstruct42_0.gstruct34_0[k].int_0;
				}
			}
			else
			{
				Form1.gstruct42_0[num].gstruct34_0 = null;
			}
			Thread.Sleep(600);
			Form1.gstruct42_0[num].bool_15 = false;
			return true;
		}
		return false;
	}
