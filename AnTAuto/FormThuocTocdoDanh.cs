...
public class FormThuocTocdoDanh : Form
{
	...
	private void timer_0_Tick(object sender, EventArgs e)
	{
		...
		else if (int_1 != int_0)
		{
			...
			else
			{
				...
				method_0(Form1.gstruct42_0[num].string_6);
			}
		}
	}
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_6 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].string_6.Length; i++)
			{
				if (Form1.gstruct42_0[num].string_6[i] == text)
				{
					return;
				}
			}
		...
		Class11.smethod_24(ref Form1.gstruct42_0[num].string_6, text);
	}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		if (Form1.gstruct42_0[num].string_6 != null)
		{
			for (i = 0; i < Form1.gstruct42_0[num].string_6.Length; i++)
			{
				if (Class10.smethod_1(Form1.gstruct42_0[num].string_6[i], 1) == text)
				{
					Class11.smethod_25(ref Form1.gstruct42_0[num].string_6, Form1.gstruct42_0[num].string_6[i]);
					break;
				}
			}
		}
			...
			try
			{
				for (int i = 0; i < Form1.gstruct42_0.Length; i++)
				{
					if (i != num)
					{
						if (Form1.gstruct42_0[num].string_6 == null)
						{
							Form1.gstruct42_0[i].string_6 = null;
						}
						else
						{
							Form1.gstruct42_0[i].string_6 = new string[Form1.gstruct42_0[num].string_6.Length];
							for (int j = 0; j < Form1.gstruct42_0[num].string_6.Length; j++)
							{
								Form1.gstruct42_0[i].string_6[j] = Form1.gstruct42_0[num].string_6[j];
							}
						}
						if (Form1.gstruct42_0[num].int_65 != null)
						{
							if (Form1.gstruct42_0[i].int_65 == null)
							{
								Form1.gstruct42_0[i].int_65 = new int[Form1.gstruct42_0[num].int_65.Length];
							}
							for (int j = 0; j < Form1.gstruct42_0[num].int_65.Length; j++)
							{
								if (j != 1)
								{
									Form1.gstruct42_0[i].int_65[j] = Form1.gstruct42_0[num].int_65[j];
								}
							}
						}
	...
	private void textBoxGiay_TextChanged(object sender, EventArgs e)
	{
		...
		if (num >= 0)
		{
			...
			Form1.gstruct42_0[num].int_65[2] = num2;
		}
	}
