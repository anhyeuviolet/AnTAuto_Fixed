...
public class FormMagic : Form
{
	...
	private void checkBoxBuaXongRoidanh_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			Form1.gstruct42_0[num].int_5 = Convert.ToByte(checkBoxBuaXongRoidanh.Checked);
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
	...
	{
		int num = Class71.smethod_3(Form1.gstruct42_0, int_1);
		if (num < 0 || (Form1.gstruct42_0[num].int_3 != null && Form1.gstruct42_0[num].int_3.Length > 3))
		{
			return;
		}
		...
		if (Form1.gstruct42_0[num].int_3 != null)
		{
			for (int i = 0; i < Form1.gstruct42_0[num].int_3.Length; i++)
			{
				if (Form1.gstruct42_0[num].int_3[i] == gstruct32_3[num2].uint_0)
				{
					return;
				}
			}
		}
		Class11.smethod_32(ref Form1.gstruct42_0[num].int_3, (int)gstruct32_3[num2].uint_0);
		method_0(gstruct32_3[num2]);
		Class47.smethod_11(Form1.gstruct42_0[num]);
		buttonThem.Enabled = (Form1.gstruct42_0[num].int_3 == null || Form1.gstruct42_0[num].int_3.Length < 4);
		buttonXoa.Enabled = (Form1.gstruct42_0[num].int_3 != null && Form1.gstruct42_0[num].int_3.Length > 0);
	}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		int num3 = Class71.smethod_3(Form1.gstruct42_0, int_1);
		if (num3 < 0)
		{
			return;
		}
		if (Form1.gstruct42_0[num3].int_3 != null)
		{
			for (int i = 0; i < gstruct32_3.Length; i++)
			{
				if (Class11.smethod_2(text, gstruct32_3[i].string_0) == 0)
				{
					Class11.smethod_33(ref Form1.gstruct42_0[num3].int_3, (int)gstruct32_3[i].uint_0);
					break;
				}
			}
		}
		Class47.smethod_11(Form1.gstruct42_0[num3]);
		buttonXoa.Enabled = (Form1.gstruct42_0[num3].int_3 != null && Form1.gstruct42_0[num3].int_3.Length > 0);
		buttonThem.Enabled = (Form1.gstruct42_0[num3].int_3 == null || Form1.gstruct42_0[num3].int_3.Length < 4);
	}
	...
	private void checkBoxChiBuff_CheckedChanged(object sender, EventArgs e)
	{
		if (timer_0.Enabled)
		{
			...
			Form1.gstruct42_0[num].int_6 = Convert.ToByte(checkBoxChiBuff.Checked);
			Class47.smethod_11(Form1.gstruct42_0[num]);
		}
	}
}
